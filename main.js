...
parcelRequire.register("eyyP1", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");

var $heSbL = parcelRequire("heSbL");

var $cihnF = parcelRequire("cihnF");

var $fWpeO = parcelRequire("fWpeO");

var $bWxtt = parcelRequire("bWxtt");
/**
 * Create an instance of Axios
 *
 * @param {Object} defaultConfig The default config for the instance
 * @return {Axios} A new instance of Axios
 */ function $a98f40922f0d398c$var$createInstance(defaultConfig) {
    var context = new $cihnF(defaultConfig);
    var instance = $heSbL($cihnF.prototype.request, context);
    // Copy axios.prototype to instance
    $bUugH.extend(instance, $cihnF.prototype, context);
    // Copy context to instance
    $bUugH.extend(instance, context);
    return instance;
}
// Create the default instance to be exported
var $a98f40922f0d398c$var$axios = $a98f40922f0d398c$var$createInstance($bWxtt);
// Expose Axios class to allow class inheritance
$a98f40922f0d398c$var$axios.Axios = $cihnF;
// Factory for creating new instances
$a98f40922f0d398c$var$axios.create = function create(instanceConfig) {
    return $a98f40922f0d398c$var$createInstance($fWpeO($a98f40922f0d398c$var$axios.defaults, instanceConfig));
};

// Expose Cancel & CancelToken
$a98f40922f0d398c$var$axios.Cancel = (parcelRequire("fxDS8"));

$a98f40922f0d398c$var$axios.CancelToken = (parcelRequire("6xVCZ"));

$a98f40922f0d398c$var$axios.isCancel = (parcelRequire("8slwY"));
// Expose all/spread
$a98f40922f0d398c$var$axios.all = function all(promises) {
    return Promise.all(promises);
};

$a98f40922f0d398c$var$axios.spread = (parcelRequire("fGy4e"));

// Expose isAxiosError
$a98f40922f0d398c$var$axios.isAxiosError = (parcelRequire("fYfmV"));
module.exports = $a98f40922f0d398c$var$axios;
// Allow use of default import syntax in TypeScript
module.exports.default = $a98f40922f0d398c$var$axios;

});
parcelRequire.register("bUugH", function(module, exports) {
"use strict";

var $heSbL = parcelRequire("heSbL");
// utils is a library of generic helper functions non-specific to axios
var $8abc6755359da735$var$toString = Object.prototype.toString;
/**
 * Determine if a value is an Array
 *
 * @param {Object} val The value to test
 * @returns {boolean} True if value is an Array, otherwise false
 */ function $8abc6755359da735$var$isArray(val) {
    return $8abc6755359da735$var$toString.call(val) === "[object Array]";
}
/**
 ...
 */ function $8abc6755359da735$var$isUndefined(val) {
 ...
 */ function $8abc6755359da735$var$isBuffer(val) {
    return val !== null && !$8abc6755359da735$var$isUndefined(val) && val.constructor !== null && !$8abc6755359da735$var$isUndefined(val.constructor) && typeof val.constructor.isBuffer === "function" && val.constructor.isBuffer(val);
}
/**
 ...
 */ function $8abc6755359da735$var$isArrayBuffer(val) {
    return $8abc6755359da735$var$toString.call(val) === "[object ArrayBuffer]";
}
/**
 ...
 */ function $8abc6755359da735$var$isFormData(val) {
 ...
 */ function $8abc6755359da735$var$isArrayBufferView(val) {
    var result;
 ...
 */ function $8abc6755359da735$var$isString(val) {
 ...
 */ function $8abc6755359da735$var$isNumber(val) {
 ...
 */ function $8abc6755359da735$var$isObject(val) {
 ...
 */ function $8abc6755359da735$var$isPlainObject(val) {
    if ($8abc6755359da735$var$toString.call(val) !== "[object Object]") return false;
 ...
 */ function $8abc6755359da735$var$isDate(val) {
    return $8abc6755359da735$var$toString.call(val) === "[object Date]";
}
/**
 ...
 */ function $8abc6755359da735$var$isFile(val) {
    return $8abc6755359da735$var$toString.call(val) === "[object File]";
}
/**
 ...
 */ function $8abc6755359da735$var$isBlob(val) {
    return $8abc6755359da735$var$toString.call(val) === "[object Blob]";
}
/**
 ...
 */ function $8abc6755359da735$var$isFunction(val) {
    return $8abc6755359da735$var$toString.call(val) === "[object Function]";
}
/**
 ...
 */ function $8abc6755359da735$var$isStream(val) {
    return $8abc6755359da735$var$isObject(val) && $8abc6755359da735$var$isFunction(val.pipe);
}
/**
 ...
 */ function $8abc6755359da735$var$isURLSearchParams(val) {
 ...
 */ function $8abc6755359da735$var$trim(str) {
 ...
 */ function $8abc6755359da735$var$isStandardBrowserEnv() {
 ...
 */ function $8abc6755359da735$var$forEach(obj, fn) {
    ...
    if ($8abc6755359da735$var$isArray(obj)) // Iterate over array values
 ...
 */ function $8abc6755359da735$var$merge() {
    var result = {};
    function assignValue(val, key) {
        if ($8abc6755359da735$var$isPlainObject(result[key]) && $8abc6755359da735$var$isPlainObject(val)) result[key] = $8abc6755359da735$var$merge(result[key], val);
        else if ($8abc6755359da735$var$isPlainObject(val)) result[key] = $8abc6755359da735$var$merge({}, val);
        else if ($8abc6755359da735$var$isArray(val)) result[key] = val.slice();
        else result[key] = val;
    }
    for(var i = 0, l = arguments.length; i < l; i++)$8abc6755359da735$var$forEach(arguments[i], assignValue);
    return result;
}
/**
 ...
 */ function $8abc6755359da735$var$extend(a, b, thisArg) {
    $8abc6755359da735$var$forEach(b, function assignValue(val, key) {
        if (thisArg && typeof val === "function") a[key] = $heSbL(val, thisArg);
        else a[key] = val;
    });
    return a;
}
 ...
 */ function $8abc6755359da735$var$stripBOM(content) {
    if (content.charCodeAt(0) === 0xFEFF) content = content.slice(1);
    return content;
}
module.exports = {
    isArray: $8abc6755359da735$var$isArray,
    isArrayBuffer: $8abc6755359da735$var$isArrayBuffer,
    isBuffer: $8abc6755359da735$var$isBuffer,
    isFormData: $8abc6755359da735$var$isFormData,
    isArrayBufferView: $8abc6755359da735$var$isArrayBufferView,
    isString: $8abc6755359da735$var$isString,
    isNumber: $8abc6755359da735$var$isNumber,
    isObject: $8abc6755359da735$var$isObject,
    isPlainObject: $8abc6755359da735$var$isPlainObject,
    isUndefined: $8abc6755359da735$var$isUndefined,
    isDate: $8abc6755359da735$var$isDate,
    isFile: $8abc6755359da735$var$isFile,
    isBlob: $8abc6755359da735$var$isBlob,
    isFunction: $8abc6755359da735$var$isFunction,
    isStream: $8abc6755359da735$var$isStream,
    isURLSearchParams: $8abc6755359da735$var$isURLSearchParams,
    isStandardBrowserEnv: $8abc6755359da735$var$isStandardBrowserEnv,
    forEach: $8abc6755359da735$var$forEach,
    merge: $8abc6755359da735$var$merge,
    extend: $8abc6755359da735$var$extend,
    trim: $8abc6755359da735$var$trim,
    stripBOM: $8abc6755359da735$var$stripBOM
};

});
parcelRequire.register("heSbL", function(module, exports) {
"use strict";
...
parcelRequire.register("cihnF", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");

var $333Is = parcelRequire("333Is");

var $9N6XE = parcelRequire("9N6XE");

var $QLh2b = parcelRequire("QLh2b");

var $fWpeO = parcelRequire("fWpeO");

var $bfRnY = parcelRequire("bfRnY");
var $8f34a5f08b9b3f47$var$validators = $bfRnY.validators;
/**
 * Create a new instance of Axios
 *
 * @param {Object} instanceConfig The default config for the instance
 */ function $8f34a5f08b9b3f47$var$Axios(instanceConfig) {
 ...
 */ $8f34a5f08b9b3f47$var$Axios.prototype.request = function request(config) {
    /*eslint no-param-reassign:0*/ // Allow for axios('example/url'[, config]) a la fetch API
    if (typeof config === "string") {
        config = arguments[1] || {};
        config.url = arguments[0];
    } else config = config || {};
    config = $fWpeO(this.defaults, config);
    // Set config.method
    if (config.method) config.method = config.method.toLowerCase();
    else if (this.defaults.method) config.method = this.defaults.method.toLowerCase();
    else config.method = "get";
    var transitional = config.transitional;
    if (transitional !== undefined) $bfRnY.assertOptions(transitional, {
        silentJSONParsing: $8f34a5f08b9b3f47$var$validators.transitional($8f34a5f08b9b3f47$var$validators.boolean, "1.0.0"),
        forcedJSONParsing: $8f34a5f08b9b3f47$var$validators.transitional($8f34a5f08b9b3f47$var$validators.boolean, "1.0.0"),
        clarifyTimeoutError: $8f34a5f08b9b3f47$var$validators.transitional($8f34a5f08b9b3f47$var$validators.boolean, "1.0.0")
    }, false);
...
$8f34a5f08b9b3f47$var$Axios.prototype.getUri = function getUri(config) {
    config = $fWpeO(this.defaults, config);
    return $333Is(config.url, config.params, config.paramsSerializer).replace(/^\?/, "");
};
...
$bUugH.forEach([
    ...
    /*eslint func-names:0*/ $8f34a5f08b9b3f47$var$Axios.prototype[method] = function(url, config) {
        return this.request($fWpeO(config || {}, {
            method: method,
            url: url,
            data: (config || {}).data
        }));
...
$bUugH.forEach([
    ...
    /*eslint func-names:0*/ $8f34a5f08b9b3f47$var$Axios.prototype[method] = function(url, data, config) {
        return this.request($fWpeO(config || {}, {
            method: method,
            url: url,
            data: data
...
module.exports = $8f34a5f08b9b3f47$var$Axios;

});
parcelRequire.register("333Is", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");
function $238488d106774479$var$encode(val) {
 ...
 */ module.exports = function buildURL(url, params, paramsSerializer) {
    ...
    else if ($bUugH.isURLSearchParams(params)) serializedParams = params.toString();
    else {
        var parts = [];
        $bUugH.forEach(params, function serialize(val, key) {
            if (val === null || typeof val === "undefined") return;
            if ($bUugH.isArray(val)) key = key + "[]";
            else val = [
                val
            ];
            $bUugH.forEach(val, function parseValue(v) {
                if ($bUugH.isDate(v)) v = v.toISOString();
                else if ($bUugH.isObject(v)) v = JSON.stringify(v);
                parts.push($238488d106774479$var$encode(key) + "=" + $238488d106774479$var$encode(v));
            });
        });
...
parcelRequire.register("9N6XE", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");
function $720e16f8e2af9e58$var$InterceptorManager() {
    this.handlers = [];
}
/**
 ...
 */ $720e16f8e2af9e58$var$InterceptorManager.prototype.use = function use(fulfilled, rejected, options) {
    this.handlers.push({
        fulfilled: fulfilled,
        rejected: rejected,
 ...
 */ $720e16f8e2af9e58$var$InterceptorManager.prototype.eject = function eject(id) {
 ...
 */ $720e16f8e2af9e58$var$InterceptorManager.prototype.forEach = function forEach(fn) {
    $bUugH.forEach(this.handlers, function forEachHandler(h) {
        if (h !== null) fn(h);
    });
};
module.exports = $720e16f8e2af9e58$var$InterceptorManager;

});

parcelRequire.register("QLh2b", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");

var $b9wvD = parcelRequire("b9wvD");

var $8slwY = parcelRequire("8slwY");

var $bWxtt = parcelRequire("bWxtt");
/**
 * Throws a `Cancel` if cancellation has been requested.
 */ function $09e987062dafa85d$var$throwIfCancellationRequested(config) {
 ...
 */ module.exports = function dispatchRequest(config) {
    $09e987062dafa85d$var$throwIfCancellationRequested(config);
    // Ensure headers exist
    config.headers = config.headers || {};
    // Transform request data
    config.data = $b9wvD.call(config, config.data, config.headers, config.transformRequest);
    // Flatten headers
    config.headers = $bUugH.merge(config.headers.common || {}, config.headers[config.method] || {}, config.headers);
    $bUugH.forEach([
        "delete",
        "get",
        "head",
    ...
    var adapter = config.adapter || $bWxtt.adapter;
    return adapter(config).then(function onAdapterResolution(response) {
        $09e987062dafa85d$var$throwIfCancellationRequested(config);
        // Transform response data
        response.data = $b9wvD.call(config, response.data, response.headers, config.transformResponse);
        return response;
    }, function onAdapterRejection(reason) {
        if (!$8slwY(reason)) {
            $09e987062dafa85d$var$throwIfCancellationRequested(config);
            // Transform response data
            if (reason && reason.response) reason.response.data = $b9wvD.call(config, reason.response.data, reason.response.headers, config.transformResponse);
        }
...
parcelRequire.register("b9wvD", function(module, exports) {
"use strict";
 ...
 */ module.exports = function transformData(data, headers, fns) {
    var context = this || $bWxtt;
    /*eslint no-param-reassign:0*/ $bUugH.forEach(fns, function transform(fn) {
...
parcelRequire.register("bWxtt", function(module, exports) {

"use strict";

var $bUugH = parcelRequire("bUugH");

var $2JWNz = parcelRequire("2JWNz");

var $5Iz0x = parcelRequire("5Iz0x");
var $8b1f13d08e1b1a13$var$DEFAULT_CONTENT_TYPE = {
    "Content-Type": "application/x-www-form-urlencoded"
};
function $8b1f13d08e1b1a13$var$setContentTypeIfUnset(headers, value) {
    if (!$bUugH.isUndefined(headers) && $bUugH.isUndefined(headers["Content-Type"])) headers["Content-Type"] = value;
}


function $8b1f13d08e1b1a13$var$getDefaultAdapter() {
    var adapter;
    if (typeof XMLHttpRequest !== "undefined") // For browsers use XHR adapter
    adapter = (parcelRequire("5JlIT"));
    else if (typeof $bFvJb$process !== "undefined" && Object.prototype.toString.call($bFvJb$process) === "[object process]") // For node use HTTP adapter
    adapter = (parcelRequire("5JlIT"));
    return adapter;
}
function $8b1f13d08e1b1a13$var$stringifySafely(rawValue, parser, encoder) {
    if ($bUugH.isString(rawValue)) try {
        (parser || JSON.parse)(rawValue);
        return $bUugH.trim(rawValue);
    } catch (e) {
        if (e.name !== "SyntaxError") throw e;
    }
    return (encoder || JSON.stringify)(rawValue);
}
var $8b1f13d08e1b1a13$var$defaults = {
    transitional: {
        silentJSONParsing: true,
        forcedJSONParsing: true,
        clarifyTimeoutError: false
    },
    adapter: $8b1f13d08e1b1a13$var$getDefaultAdapter(),
    transformRequest: [
        function transformRequest(data, headers) {
            $2JWNz(headers, "Accept");
            $2JWNz(headers, "Content-Type");
            if ($bUugH.isFormData(data) || $bUugH.isArrayBuffer(data) || $bUugH.isBuffer(data) || $bUugH.isStream(data) || $bUugH.isFile(data) || $bUugH.isBlob(data)) return data;
            if ($bUugH.isArrayBufferView(data)) return data.buffer;
            if ($bUugH.isURLSearchParams(data)) {
                $8b1f13d08e1b1a13$var$setContentTypeIfUnset(headers, "application/x-www-form-urlencoded;charset=utf-8");
                return data.toString();
            }
            if ($bUugH.isObject(data) || headers && headers["Content-Type"] === "application/json") {
                $8b1f13d08e1b1a13$var$setContentTypeIfUnset(headers, "application/json");
                return $8b1f13d08e1b1a13$var$stringifySafely(data);
            }
            return data;
        }
    ],
    transformResponse: [
        function transformResponse(data) {
            ...
            if (strictJSONParsing || forcedJSONParsing && $bUugH.isString(data) && data.length) try {
                return JSON.parse(data);
            } catch (e) {
                if (strictJSONParsing) {
                    if (e.name === "SyntaxError") throw $5Iz0x(e, this, "E_JSON_PARSE");
                    throw e;
                }
            }
            return data;
...
$8b1f13d08e1b1a13$var$defaults.headers = {
    common: {
...
$bUugH.forEach([
    ...
    $8b1f13d08e1b1a13$var$defaults.headers[method] = {};
});
$bUugH.forEach([
    "post",
    "put",
    ...
    $8b1f13d08e1b1a13$var$defaults.headers[method] = $bUugH.merge($8b1f13d08e1b1a13$var$DEFAULT_CONTENT_TYPE);
});
module.exports = $8b1f13d08e1b1a13$var$defaults;

});
parcelRequire.register("2JWNz", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");
module.exports = function normalizeHeaderName(headers, normalizedName) {
    $bUugH.forEach(headers, function processHeader(value, name) {
...
parcelRequire.register("5Iz0x", function(module, exports) {
"use strict";
/**
...
parcelRequire.register("5JlIT", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");

var $2HxS4 = parcelRequire("2HxS4");

var $dYMd2 = parcelRequire("dYMd2");

var $333Is = parcelRequire("333Is");

var $jhkSm = parcelRequire("jhkSm");

var $gPv5T = parcelRequire("gPv5T");

var $hvSaA = parcelRequire("hvSaA");

var $hxaXE = parcelRequire("hxaXE");
module.exports = function xhrAdapter(config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
        var requestData = config.data;
        var requestHeaders = config.headers;
        var responseType = config.responseType;
        if ($bUugH.isFormData(requestData)) delete requestHeaders["Content-Type"]; // Let the browser set it
        ...
        var fullPath = $jhkSm(config.baseURL, config.url);
        request.open(config.method.toUpperCase(), $333Is(fullPath, config.params, config.paramsSerializer), true);
        // Set the request timeout in MS
        request.timeout = config.timeout;
        function onloadend() {
            if (!request) return;
            // Prepare the response
            var responseHeaders = "getAllResponseHeaders" in request ? $gPv5T(request.getAllResponseHeaders()) : null;
        ...
        request.onabort = function handleAbort() {
            if (!request) return;
            reject($hxaXE("Request aborted", config, "ECONNABORTED", request));
            // Clean up request
            request = null;
        };
        ...
        request.onerror = function handleError() {
            ...
            reject($hxaXE("Network Error", config, null, request));
            // Clean up request
            request = null;
        };
        // Handle timeout
        request.ontimeout = function handleTimeout() {
            ...
            reject($hxaXE(timeoutErrorMessage, config, config.transitional && config.transitional.clarifyTimeoutError ? "ETIMEDOUT" : "ECONNABORTED", request));
            // Clean up request
            request = null;
        };
        // Add xsrf header
        ...
        if ($bUugH.isStandardBrowserEnv()) {
            // Add xsrf header
            var xsrfValue = (config.withCredentials || $hvSaA(fullPath)) && config.xsrfCookieName ? $dYMd2.read(config.xsrfCookieName) : undefined;
            if (xsrfValue) requestHeaders[config.xsrfHeaderName] = xsrfValue;
        }
        // Add headers to the request
        if ("setRequestHeader" in request) $bUugH.forEach(requestHeaders, function setRequestHeader(val, key) {
        ...
        if (!$bUugH.isUndefined(config.withCredentials)) request.withCredentials = !!config.withCredentials;
...
parcelRequire.register("2HxS4", function(module, exports) {
"use strict";
 ...
 */ module.exports = function settle(resolve, reject, response) {
    ...
    else reject($hxaXE("Request failed with status code " + response.status, response.config, null, response.request, response));
};

});
parcelRequire.register("hxaXE", function(module, exports) {
"use strict";
 ...
 */ module.exports = function createError(message, config, code, request, response) {
    ...
    return $5Iz0x(error, config, code, request, response);
};

});


parcelRequire.register("dYMd2", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");
module.exports = $bUugH.isStandardBrowserEnv() ? // Standard browser envs support document.cookie
function standardBrowserEnv() {
    return {
        write: function write(name, value, expires, path, domain, secure) {
            var cookie = [];
            cookie.push(name + "=" + encodeURIComponent(value));
            if ($bUugH.isNumber(expires)) cookie.push("expires=" + new Date(expires).toGMTString());
            if ($bUugH.isString(path)) cookie.push("path=" + path);
            if ($bUugH.isString(domain)) cookie.push("domain=" + domain);
...
parcelRequire.register("jhkSm", function(module, exports) {
"use strict";

var $lKfsW = parcelRequire("lKfsW");

var $f3I0h = parcelRequire("f3I0h");
/**
 ...
 */ module.exports = function buildFullPath(baseURL, requestedURL) {
    if (baseURL && !$lKfsW(requestedURL)) return $f3I0h(baseURL, requestedURL);
    return requestedURL;
};

});
parcelRequire.register("lKfsW", function(module, exports) {
"use strict";
/**
...
parcelRequire.register("f3I0h", function(module, exports) {
"use strict";
/**
...
parcelRequire.register("gPv5T", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");
// Headers whose duplicates are ignored by node
// c.f. https://nodejs.org/api/http.html#http_message_headers
var $c4098762448161e2$var$ignoreDuplicateOf = [
    "age",
    "authorization",
    "content-length",
    "content-type",
 ...
 */ module.exports = function parseHeaders(headers) {
    ...
    $bUugH.forEach(headers.split("\n"), function parser(line) {
        i = line.indexOf(":");
        key = $bUugH.trim(line.substr(0, i)).toLowerCase();
        val = $bUugH.trim(line.substr(i + 1));
        if (key) {
            if (parsed[key] && $c4098762448161e2$var$ignoreDuplicateOf.indexOf(key) >= 0) return;
...
parcelRequire.register("hvSaA", function(module, exports) {
"use strict";

var $bUugH = parcelRequire("bUugH");
module.exports = $bUugH.isStandardBrowserEnv() ? // Standard browser envs have full support of the APIs needed to test
...
function standardBrowserEnv() {
    ...
    */ return function isURLSameOrigin(requestURL) {
        var parsed = $bUugH.isString(requestURL) ? resolveURL(requestURL) : requestURL;
...
parcelRequire.register("8slwY", function(module, exports) {
"use strict";
...
parcelRequire.register("fWpeO", function(module, exports) {
"use strict";
 ...
 */ module.exports = function mergeConfig(config1, config2) {
    ...
    function getMergedValue(target, source) {
        if ($bUugH.isPlainObject(target) && $bUugH.isPlainObject(source)) return $bUugH.merge(target, source);
        else if ($bUugH.isPlainObject(source)) return $bUugH.merge({}, source);
        else if ($bUugH.isArray(source)) return source.slice();
        return source;
    }
    function mergeDeepProperties(prop) {
        if (!$bUugH.isUndefined(config2[prop])) config[prop] = getMergedValue(config1[prop], config2[prop]);
        else if (!$bUugH.isUndefined(config1[prop])) config[prop] = getMergedValue(undefined, config1[prop]);
    }
    $bUugH.forEach(valueFromConfig2Keys, function valueFromConfig2(prop) {
        if (!$bUugH.isUndefined(config2[prop])) config[prop] = getMergedValue(undefined, config2[prop]);
    });
    $bUugH.forEach(mergeDeepPropertiesKeys, mergeDeepProperties);
    $bUugH.forEach(defaultToConfig2Keys, function defaultToConfig2(prop) {
        if (!$bUugH.isUndefined(config2[prop])) config[prop] = getMergedValue(undefined, config2[prop]);
        else if (!$bUugH.isUndefined(config1[prop])) config[prop] = getMergedValue(undefined, config1[prop]);
    });
    $bUugH.forEach(directMergeKeys, function merge(prop) {
    ...
    $bUugH.forEach(otherKeys, mergeDeepProperties);
    return config;
};

});

parcelRequire.register("bfRnY", function(module, exports) {
"use strict";

var $7LHZu = parcelRequire("7LHZu");
var $831a81b0284333b6$var$validators = {};
...
[
    ...
    $831a81b0284333b6$var$validators[type] = function validator(thing) {
        return typeof thing === type || "a" + (i < 1 ? "n " : " ") + type;
    };
});
var $831a81b0284333b6$var$deprecatedWarnings = {};
var $831a81b0284333b6$var$currentVerArr = $7LHZu.version.split(".");
/**
 * Compare package versions
 * @param {string} version
 * @param {string?} thanVersion
 * @returns {boolean}
 */ function $831a81b0284333b6$var$isOlderVersion(version, thanVersion) {
    var pkgVersionArr = thanVersion ? thanVersion.split(".") : $831a81b0284333b6$var$currentVerArr;
 ...
 * @returns {function}
 */ $831a81b0284333b6$var$validators.transitional = function transitional(validator, version, message) {
    var isDeprecated = version && $831a81b0284333b6$var$isOlderVersion(version);
    function formatMessage(opt, desc) {
        return "[Axios v" + $7LHZu.version + "] Transitional option '" + opt + "'" + desc + (message ? ". " + message : "");
    }
    // eslint-disable-next-line func-names
    return function(value, opt, opts) {
        if (validator === false) throw new Error(formatMessage(opt, " has been removed in " + version));
        if (isDeprecated && !$831a81b0284333b6$var$deprecatedWarnings[opt]) {
            $831a81b0284333b6$var$deprecatedWarnings[opt] = true;
 ...
 */ function $831a81b0284333b6$var$assertOptions(options, schema, allowUnknown) {
...
module.exports = {
    isOlderVersion: $831a81b0284333b6$var$isOlderVersion,
    assertOptions: $831a81b0284333b6$var$assertOptions,
    validators: $831a81b0284333b6$var$validators
};

});
parcelRequire.register("7LHZu", function(module, exports) {
...
parcelRequire.register("fxDS8", function(module, exports) {
"use strict";
/**
 ...
 */ function $b508dde1a5217b7b$var$Cancel(message) {
    this.message = message;
}
$b508dde1a5217b7b$var$Cancel.prototype.toString = function toString() {
    return "Cancel" + (this.message ? ": " + this.message : "");
};
$b508dde1a5217b7b$var$Cancel.prototype.__CANCEL__ = true;
module.exports = $b508dde1a5217b7b$var$Cancel;

});

parcelRequire.register("6xVCZ", function(module, exports) {
"use strict";

var $fxDS8 = parcelRequire("fxDS8");
/**
 * A `CancelToken` is an object that can be used to request cancellation of an operation.
 *
 * @class
 * @param {Function} executor The executor function.
 */ function $4c4286d29ab4c7ca$var$CancelToken(executor) {
    ...
    executor(function cancel(message) {
        ...
        return;
        token.reason = new $fxDS8(message);
        resolvePromise(token.reason);
    });
}
/**
 * Throws a `Cancel` if cancellation has been requested.
 */ $4c4286d29ab4c7ca$var$CancelToken.prototype.throwIfRequested = function throwIfRequested() {
    if (this.reason) throw this.reason;
};
/**
 * Returns an object that contains a new `CancelToken` and a function that, when called,
 * cancels the `CancelToken`.
 */ $4c4286d29ab4c7ca$var$CancelToken.source = function source() {
    var cancel;
    var token = new $4c4286d29ab4c7ca$var$CancelToken(function executor(c) {
        cancel = c;
    });
    return {
        token: token,
...
module.exports = $4c4286d29ab4c7ca$var$CancelToken;

});

parcelRequire.register("fGy4e", function(module, exports) {
"use strict";
/**
...
parcelRequire.register("fYfmV", function(module, exports) {
"use strict";
/**
...
(function(sax) {
    ...
    SAXStream.prototype.write = function(data) {
        if (typeof $1664702c653a110c$require$Buffer === "function" && typeof $1664702c653a110c$require$Buffer.isBuffer === "function" && $1664702c653a110c$require$Buffer.isBuffer(data)) {
            if (!this._decoder) {
...
"use strict";
var $5cba0eef33ad0e88$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};

const $5cba0eef33ad0e88$var$http_1 = $5cba0eef33ad0e88$var$__importDefault($bFvJb$http);

const $5cba0eef33ad0e88$var$https_1 = $5cba0eef33ad0e88$var$__importDefault($bFvJb$https);
...
const $5cba0eef33ad0e88$var$retryStatusCodes = new Set([
    429,
    503
]);
...
const $5cba0eef33ad0e88$var$responseEvents = [
    "aborted"
];
$5cba0eef33ad0e88$var$Miniget.MinigetError = class MinigetError extends Error {
...
function $5cba0eef33ad0e88$var$Miniget(url, options = {}) {
    var _a;
    const opts = Object.assign({}, $5cba0eef33ad0e88$var$Miniget.defaultOptions, options);
    ...
    if (opts.acceptEncoding) opts.headers = Object.assign({
    ...
    const doDownload = ()=>{
        ...
        try {
            ...
            if (urlObj.username) parsed.auth = `${urlObj.username}:${urlObj.password}`;
            httpLib = $5cba0eef33ad0e88$var$httpLibs[String(parsed.protocol)];
        } catch (err) {
        // Let the error be caught by the if statement below.
        }
        if (!httpLib) {
            stream.emit("error", new $5cba0eef33ad0e88$var$Miniget.MinigetError(`Invalid URL: ${url}`));
            return;
        }
        ...
        if (opts.transform) {
            ...
            if (!parsed || parsed.protocol) {
                httpLib = $5cba0eef33ad0e88$var$httpLibs[String(parsed === null || parsed === void 0 ? void 0 : parsed.protocol)];
                if (!httpLib) {
                    stream.emit("error", new $5cba0eef33ad0e88$var$Miniget.MinigetError("Invalid URL object from `transform` function"));
                    return;
                }
            }
        }
        ...
        const cleanup = ()=>{
            ...
            activeResponse === null || activeResponse === void 0 || activeResponse.removeListener("data", onData);
            activeDecodedStream === null || activeDecodedStream === void 0 || activeDecodedStream.removeListener("end", onEnd);
        };
        const onData = (chunk)=>{
        ...
        activeRequest = httpLib.request(parsed, (res)=>{
            ...
            if ($5cba0eef33ad0e88$var$redirectStatusCodes.has(res.statusCode)) {
                if (redirects++ >= opts.maxRedirects) stream.emit("error", new $5cba0eef33ad0e88$var$Miniget.MinigetError("Too many redirects"));
                else {
                    if (res.headers.location) url = res.headers.location;
                    else {
                        let err = new $5cba0eef33ad0e88$var$Miniget.MinigetError("Redirect status code given with no location", res.statusCode);
                        stream.emit("error", err);
                        cleanup();
                        return;
                    }
            ...
            // Check for rate limiting.
                ...
                if (!retryRequest({
                    ...
                    let err = new $5cba0eef33ad0e88$var$Miniget.MinigetError(`Status code: ${res.statusCode}`, res.statusCode);
                    stream.emit("error", err);
                }
                cleanup();
                return;
            ...
            if (opts.acceptEncoding && res.headers["content-encoding"]) for (let enc of res.headers["content-encoding"].split(", ").reverse()){
    ...
    const streamDestroy = (err)=>{
        ...
        activeDecodedStream === null || activeDecodedStream === void 0 || activeDecodedStream.unpipe(stream);
        activeDecodedStream === null || activeDecodedStream === void 0 || activeDecodedStream.destroy();
 ...
 */ class $adf1143074688897$var$m3u8Parser extends $bFvJb$stream.Writable {
    ...
    _parseAttrList(value) {
        ...
        let regex = /([A-Z0-9-]+)=(?:"([^"]*?)"|([^,]*?))/g;
        let match;
        while((match = regex.exec(value)) !== null)attrs[match[1]] = match[2] || match[3];
        return attrs;
    }
    _parseRange(value) {
    ...
    _write(chunk, encoding, callback) {
        ...
        lines.forEach((line, i)=>{
            ...
            else // Save the last line in case it has been broken up.
            this._lastLine = line;
        });
        callback();
    }
...
"use strict";
var $9f3c2eab8727b8fa$var$__importDefault = module.exports && module.exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};
...
const $9f3c2eab8727b8fa$var$sax_1 = $9f3c2eab8727b8fa$var$__importDefault((parcelRequire("1Vc1h")));
 ...
 */ class $9f3c2eab8727b8fa$var$DashMPDParser extends $bFvJb$stream.Writable {
    constructor(targetID){
        ...
        const onEnd = ()=>{
            ...
            if (!getSegments) this.destroy(Error(`Representation '${targetID}' not found`));
            else this.emit("end");
        };
            ...
            switch(tagName){
                ...
                case "representation":
                    ...
                    if (segmentTemplate && timeline.length) {
                        gotSegments = true;
                        if (segmentTemplate.initialization) this.emit("item", {
                            url: baseURL.filter((s)=>!!s).join("") + tmpl(segmentTemplate.initialization),
                            seq: seq,
                            init: true,
                            duration: 0
                        });
                        for (let { duration: itemDuration , repeat: repeat , time: time  } of timeline){
...
const $b78885f33a064ca4$var$timeFormat = /^(?:(?:(\d+):)?(\d{1,2}):)?(\d{1,2})(?:\.(\d{3}))?$/;
 ...
 */ module.exports.humanStr = (time)=>{
    ...
    if (firstFormat) return +(firstFormat[1] || 0) * $b78885f33a064ca4$var$timeUnits.h + +(firstFormat[2] || 0) * $b78885f33a064ca4$var$timeUnits.m + +firstFormat[3] * $b78885f33a064ca4$var$timeUnits.s + +(firstFormat[4] || 0);
    else {
        let total = 0;
        const r = /(-?\d+)(ms|s|m|h)/g;
        let rs;
        while((rs = r.exec(time)) !== null)total += +rs[1] * $b78885f33a064ca4$var$timeUnits[rs[2]];
        return total;
    }
};
/**
 ...
 */ module.exports.durationStr = (time)=>{
    ...
    const r = /(\d+(?:\.\d+)?)(S|M|H)/g;
    let rs;
    while((rs = r.exec(time)) !== null)total += +rs[1] * $b78885f33a064ca4$var$timeUnits[rs[2].toLowerCase()];
    return total;
};
...
/*jshint node:true*/ var $2767829f9004576b$var$__dirname = "node_modules/fluent-ffmpeg/lib";
"use strict";
 ...
 */ function $2767829f9004576b$var$FfmpegCommand(input, options) {
    // Make 'new' optional
    if (!(this instanceof $2767829f9004576b$var$FfmpegCommand)) return new $2767829f9004576b$var$FfmpegCommand(input, options);
    $2767829f9004576b$require$EventEmitter.call(this);
    if (typeof input === "object" && !("readable" in input)) // Options object passed directly
    options = input;
    else {
        // Input passed first
        options = options || {};
    ...
    options.presets = options.presets || options.preset || $bFvJb$path.join($2767829f9004576b$var$__dirname, "presets");
...
$bFvJb$util.inherits($2767829f9004576b$var$FfmpegCommand, $2767829f9004576b$require$EventEmitter);
 ...
 */ $2767829f9004576b$var$FfmpegCommand.prototype.clone = function() {
    ...
    if ("target" in this._outputs[0]) {
        ...
        if (this._currentOutput.sizeData) {
            ...
            $gOWQU.copy(this._currentOutput.sizeData, clone._currentOutput.sizeData);
        }
...
/* Add methods from options submodules */ (parcelRequire("6TC10"))($2767829f9004576b$var$FfmpegCommand.prototype);
...
/* Add processor methods */ (parcelRequire("4wWgO"))($2767829f9004576b$var$FfmpegCommand.prototype);

/* Add capabilities methods */ (parcelRequire("lCJVB"))($2767829f9004576b$var$FfmpegCommand.prototype);
...
$2767829f9004576b$var$FfmpegCommand.availableFilters = $2767829f9004576b$var$FfmpegCommand.getAvailableFilters = function(callback) {
    new $2767829f9004576b$var$FfmpegCommand().availableFilters(callback);
};
$2767829f9004576b$var$FfmpegCommand.availableCodecs = $2767829f9004576b$var$FfmpegCommand.getAvailableCodecs = function(callback) {
    new $2767829f9004576b$var$FfmpegCommand().availableCodecs(callback);
};
$2767829f9004576b$var$FfmpegCommand.availableFormats = $2767829f9004576b$var$FfmpegCommand.getAvailableFormats = function(callback) {
    new $2767829f9004576b$var$FfmpegCommand().availableFormats(callback);
};
$2767829f9004576b$var$FfmpegCommand.availableEncoders = $2767829f9004576b$var$FfmpegCommand.getAvailableEncoders = function(callback) {
    new $2767829f9004576b$var$FfmpegCommand().availableEncoders(callback);
};

/* Add ffprobe methods */ (parcelRequire("2LqKM"))($2767829f9004576b$var$FfmpegCommand.prototype);
...
/* Add processing recipes */ (parcelRequire("adNg8"))($2767829f9004576b$var$FfmpegCommand.prototype);
...
var $c3eef7b76ebda48e$var$isWindows = $bFvJb$os.platform().match(/win(32|64)/);
...
var $c3eef7b76ebda48e$var$utils = module.exports = {
   ...
   */ args: function() {
        ...
        var argfunc = function() {
            if (arguments.length === 1 && Array.isArray(arguments[0])) list = list.concat(arguments[0]);
        ...
        argfunc.find = function(arg, count) {
            ...
            if (index !== -1) return list.slice(index + 1, index + 1 + (count || 0));
        };
   ...
   */ makeFilterStrings: function(filters) {
        return filters.map(function(filterSpec) {
            ...
            // Add inputs
            if (Array.isArray(filterSpec.inputs)) filterString += filterSpec.inputs.map(function(streamSpec) {
                return streamSpec.replace($c3eef7b76ebda48e$var$streamRegexp, "[$1]");
            }).join("");
            else if (typeof filterSpec.inputs === "string") filterString += filterSpec.inputs.replace($c3eef7b76ebda48e$var$streamRegexp, "[$1]");
            // Add filter
            filterString += filterSpec.filter;
            // Add options
            if (filterSpec.options) {
                if (typeof filterSpec.options === "string" || typeof filterSpec.options === "number") // Option string
                filterString += "=" + filterSpec.options;
                else if (Array.isArray(filterSpec.options)) // Option array (unnamed options)
                filterString += "=" + filterSpec.options.map(function(option) {
                    if (typeof option === "string" && option.match($c3eef7b76ebda48e$var$filterEscapeRegexp)) return "'" + option + "'";
                    else return option;
                }).join(":");
                else if (Object.keys(filterSpec.options).length) // Option object (named options)
                filterString += "=" + Object.keys(filterSpec.options).map(function(option) {
                    var value = filterSpec.options[option];
                    if (typeof value === "string" && value.match($c3eef7b76ebda48e$var$filterEscapeRegexp)) value = "'" + value + "'";
                    return option + "=" + value;
                }).join(":");
            }
            // Add outputs
            if (Array.isArray(filterSpec.outputs)) filterString += filterSpec.outputs.map(function(streamSpec) {
                return streamSpec.replace($c3eef7b76ebda48e$var$streamRegexp, "[$1]");
            }).join("");
            else if (typeof filterSpec.outputs === "string") filterString += filterSpec.outputs.replace($c3eef7b76ebda48e$var$streamRegexp, "[$1]");
            return filterString;
        });
    },
    /**
   ...
   */ which: function(name, callback) {
        if (name in $c3eef7b76ebda48e$var$whichCache) return callback(null, $c3eef7b76ebda48e$var$whichCache[name]);
        $d2MMG(name, function(err, result) {
            if (err) // Treat errors as not found
   ...
   */ timemarkToSeconds: function(timemark) {
        ...
        if (parts.length) // add minutes
        secs += Number(parts.pop()) * 60;
        if (parts.length) // add hours
   ...
   */ extractCodecData: function(command, stderrLine, codecsObject) {
        ...
        } else if (inInput && (dur = stderrLine.match(durPattern))) inputStack[inputIndex].duration = dur[1];
        ...
        } else if (/Output #\d+/.test(stderrLine)) inInput = codecsObject.inInput = false;
   ...
   */ extractProgress: function(command, stderrLine) {
        ...
        if (progress) {
            ...
            if (command._ffprobeData && command._ffprobeData.format && command._ffprobeData.format.duration) {
                ...
                if (!isNaN(duration)) ret.percent = $c3eef7b76ebda48e$var$utils.timemarkToSeconds(ret.timemark) / duration * 100;
            }
   ...
   */ extractError: function(stderr) {
        ...
        return stderr.split($c3eef7b76ebda48e$var$nlRegexp).reduce(function(messages, message) {
        ...
        return {
            ...
            append: function(str) {
                ...
                if (newLines.length === 1) {
                    ...
                    if (max > -1 && lines.length > max) lines.splice(0, lines.length - max);
                }
            },
            get: function() {
                if (current !== null) return lines.concat([
                    current
                ]).join("\n");
...
var $97f14dcbdc726eaa$var$isWindows = $bFvJb$process.platform === "win32" || false || false;
...
function $97f14dcbdc726eaa$var$getPathInfo(cmd, opt) {
    ...
    if (cmd.match(/\//) || $97f14dcbdc726eaa$var$isWindows && cmd.match(/\\/)) pathEnv = [
        ""
    ];
    return {
        env: pathEnv,
...
if ($bFvJb$process.platform === "win32" || $parcel$global.TESTING_WINDOWS) $d9c8132d681abf95$var$core = (parcelRequire("hH5n7"));
...
function $ce1a9e952bcf5b9f$var$sync(path, options) {
    return $ce1a9e952bcf5b9f$var$checkStat($bFvJb$fs.statSync(path), path, options);
}
...
function $4b89edb59123e8b3$var$checkMode(stat, options) {
    ...
    var uid = stat.uid;
    var gid = stat.gid;
    var myUid = options.uid !== undefined ? options.uid : $bFvJb$process.getuid && $bFvJb$process.getuid();
    var myGid = options.gid !== undefined ? options.gid : $bFvJb$process.getgid && $bFvJb$process.getgid();
 ...
 */ module.exports = function(proto) {
   ...
   */ proto.mergeAdd = proto.addInput = proto.input = function(source) {
        ...
        if (typeof source !== "string") {
            if (!("readable" in source) || !source.readable) throw new Error("Invalid input");
            var hasInputStream = this._inputs.some(function(input) {
                return input.isStream;
            });
            if (hasInputStream) throw new Error("Only one input stream is supported");
            isStream = true;
            source.pause();
        } else {
 ...
 */ module.exports = function(proto) {
   ...
   */ proto.withVideoBitrate = proto.videoBitrate = function(bitrate, constant) {
        ...
        if (constant) this._currentOutput.video("-maxrate", bitrate, "-minrate", bitrate, "-bufsize", "3M");
        return this;
    };
    /**
 ...
 * @private
 */ function $80f0e35dc9cac0d2$var$getScalePadFilters(width, height, aspect, color) {
    /*
 ...
 */ function $80f0e35dc9cac0d2$var$createSizeFilters(output, key, value) {
    ...
    data[key] = value;
    if (!("size" in data)) // No size requested, keep original size
    return [];
    ...
    if (percentRatio) {
        ...
        aspect = width / height;
        if (data.pad) return $80f0e35dc9cac0d2$var$getScalePadFilters(width, height, aspect, data.pad);
        else // No autopad requested, rescale to target size
        return [
            {
                filter: "scale",
                options: {
        ...
        if ("aspect" in data) {
            ...
            if (data.pad) return $80f0e35dc9cac0d2$var$getScalePadFilters(width, height, data.aspect, data.pad);
            else // No autopad requested, rescale to target size
            return [
                {
                    filter: "scale",
 ...
 */ module.exports = function(proto) {
   ...
   */ proto.withSize = proto.setSize = proto.size = function(size) {
        var filters = $80f0e35dc9cac0d2$var$createSizeFilters(this._currentOutput, "size", size);
   ...
   */ proto.withAspect = proto.withAspectRatio = proto.setAspect = proto.setAspectRatio = proto.aspect = proto.aspectRatio = function(aspect) {
        ...
        var filters = $80f0e35dc9cac0d2$var$createSizeFilters(this._currentOutput, "aspect", a);
        this._currentOutput.sizeFilters.clear();
        this._currentOutput.sizeFilters(filters);
        return this;
    };
   ...
   */ proto.applyAutopadding = proto.applyAutoPadding = proto.applyAutopad = proto.applyAutoPad = proto.withAutopadding = proto.withAutoPadding = proto.withAutopad = proto.withAutoPad = proto.autoPad = proto.autopad = function(pad, color) {
        ...
        var filters = $80f0e35dc9cac0d2$var$createSizeFilters(this._currentOutput, "pad", pad ? color || "black" : false);
        this._currentOutput.sizeFilters.clear();
        this._currentOutput.sizeFilters(filters);
        return this;
    };
 ...
 */ module.exports = function(proto) {
   ...
   */ proto.addOutput = proto.output = function(target, pipeopts) {
        var isFile = false;
        if (!target && this._currentOutput) // No target is only allowed when called from constructor
        throw new Error("Invalid output");
        if (target && typeof target !== "string") {
            if (!("writable" in target) || !target.writable) throw new Error("Invalid output");
        ...
        if (target && !("target" in this._currentOutput)) {
            ...
            if (target && typeof target !== "string") {
                ...
                if (hasOutputStream) throw new Error("Only one output stream is supported");
            }
            ...
            if (!target) // Call from constructor: remove target key
   ...
   */ proto.map = function(spec) {
        this._currentOutput.options("-map", spec.replace($gOWQU.streamRegexp, "[$1]"));
        return this;
    };
    /**
 ...
 */ module.exports = function(proto) {
   ...
   */ proto.filterGraph = proto.complexFilter = function(spec, map) {
        ...
        this._complexFilters("-filter_complex", $gOWQU.makeFilterStrings(spec).join(";"));
        if (Array.isArray(map)) {
            var self = this;
            map.forEach(function(streamSpec) {
                self._complexFilters("-map", streamSpec.replace($gOWQU.streamRegexp, "[$1]"));
            });
        } else if (typeof map === "string") this._complexFilters("-map", map.replace($gOWQU.streamRegexp, "[$1]"));
        return this;
    };
};
 ...
 */ module.exports = function(proto) {
   ...
   */ proto.usingPreset = proto.preset = function(preset) {
        if (typeof preset === "function") preset(this);
            ...
            else throw new Error("preset " + modulePath + " has no load() function");
        } catch (err) {
 ...
 */ function $34c759d073ac7609$var$runFfprobe(command) {
    ...
    if (command._inputs[inputProbeIndex].isStream) // Don't probe input streams as this will consume them
    return;
...
module.exports = function(proto) {
   ...
   */ proto._spawnFfmpeg = function(args, options, processCB, endCB) {
        ...
        this._getFfmpegPath(function(err, command) {
            ...
            else if (!command || command.length === 0) return endCB(new Error("Cannot find ffmpeg"));
            // Apply niceness
            ...
            // Spawn process
            var ffmpegProc = $34c759d073ac7609$require$spawn(command, args, options);
            ...
            function handleExit(err) {
                ...
                if (processExited && (stdoutClosed || !options.captureStdout) && stderrClosed) endCB(exitError, stdoutRing, stderrRing);
            }
            // Handle process exit
            var processExited = false;
            ffmpegProc.on("exit", function(code, signal) {
                processExited = true;
                if (signal) handleExit(new Error("ffmpeg was killed with signal " + signal));
   ...
   */ proto._getArguments = function() {
        ...
        this._outputs.reduce(function(args, output) {
            ...
            else if (typeof output.target === "string") outputArg = [
                output.target
            ];
            else outputArg = [
                "pipe:1"
   ...
   */ proto._prepare = function(callback, readMetadata) {
        ...
        $aK4hl.waterfall([
            ...
            function(cb) {
                ...
                if (flvmeta) self._getFlvtoolPath(function(err) {
                    cb(err);
                });
                else cb();
            },
            ...
            function(args, cb) {
                self.availableEncoders(function(err, encoders) {
                    for(var i = 0; i < args.length; i++)if (args[i] === "-acodec" || args[i] === "-vcodec") {
                        i++;
        ...
        if (!readMetadata) {
            ...
            if (this.listeners("progress").length > 0) // Read metadata in parallel
            $34c759d073ac7609$var$runFfprobe(this);
            else // Read metadata as soon as the first 'progress' listener is added
   ...
   */ proto.exec = proto.execute = proto.run = function() {
        ...
        self._prepare(function(err, args) {
            ...
            self._spawnFfmpeg(args, {
                ...
                var processTimer;
                if (self.options.timeout) processTimer = setTimeout(function() {
                ...
                if (stderrRing) {
                    // 'stderr' event
                    if (self.listeners("stderr").length) stderrRing.callback(function(line) {
                    ...
                    if (self.listeners("codecData").length) {
                        ...
                        stderrRing.callback(function(line) {
                            if (!codecDataSent) codecDataSent = $gOWQU.extractCodecData(self, line, codecObject);
                        });
                    }
                    // 'progress' event
                    if (self.listeners("progress").length) stderrRing.callback(function(line) {
                ...
                if (err) {
                    if (err.message.match(/ffmpeg exited with code/)) // Add ffmpeg error message
                    ...
                    if (flvmeta.length) self._getFlvtoolPath(function(err, flvtool) {
                        if (err) return emitEnd(err);
                        $aK4hl.each(flvmeta, function(output, cb) {
                            $34c759d073ac7609$require$spawn(flvtool, [
                                ...
                                if (code !== 0 || signal) cb(new Error(flvtool + " " + (signal ? "received signal " + signal : "exited with code " + code)) + " when running on " + output.target);
                                else cb();
                            });
                        }, function(err) {
                            if (err) emitEnd(err);
   ...
   */ proto.renice = function(niceness) {
        if (!$gOWQU.isWindows) {
            niceness = niceness || 0;
            if (niceness < -20 || niceness > 20) this.logger.warn("Invalid niceness value: " + niceness + ", must be between -20 and 20");
            ...
            if (this.ffmpegProc) {
                ...
                renice.on("exit", function(code, signal) {
                    if (signal) logger.warn("could not renice process " + pid + ": renice was killed by signal " + signal);
                    else if (code) logger.warn("could not renice process " + pid + ": renice exited with " + code);
                    else logger.info("successfully reniced process " + pid + " to " + niceness + " niceness");
                });
            }
        }
        return this;
...
$parcel$export(module.exports, "each", () => $0c84690c59b4ccb2$export$79b2f7037acddd43);
$parcel$export(module.exports, "waterfall", () => $0c84690c59b4ccb2$export$981f466e0ef96280);
/**
...
/* istanbul ignore file */ var $0c84690c59b4ccb2$var$hasQueueMicrotask = typeof queueMicrotask === "function" && queueMicrotask;
var $0c84690c59b4ccb2$var$hasSetImmediate = typeof setImmediate === "function" && setImmediate;
var $0c84690c59b4ccb2$var$hasNextTick = typeof $bFvJb$process === "object" && typeof $bFvJb$process.nextTick === "function";
...
if ($0c84690c59b4ccb2$var$hasQueueMicrotask) $0c84690c59b4ccb2$var$_defer = queueMicrotask;
else if ($0c84690c59b4ccb2$var$hasSetImmediate) $0c84690c59b4ccb2$var$_defer = setImmediate;
else if ($0c84690c59b4ccb2$var$hasNextTick) $0c84690c59b4ccb2$var$_defer = $bFvJb$process.nextTick;
else $0c84690c59b4ccb2$var$_defer = $0c84690c59b4ccb2$var$fallback;
var $0c84690c59b4ccb2$export$c233f08fbfea0913 = $0c84690c59b4ccb2$var$wrap($0c84690c59b4ccb2$var$_defer);
/**
 ...
 */ function $0c84690c59b4ccb2$export$b5d55b15b1db3122(func) {
    if ($0c84690c59b4ccb2$var$isAsync(func)) return function(...args /*, callback*/ ) {
    ...
    return $0c84690c59b4ccb2$var$initialParams(function(args, callback) {
        ...
        if (result && typeof result.then === "function") return $0c84690c59b4ccb2$var$handlePromise(result, callback);
...
function $0c84690c59b4ccb2$var$handlePromise(promise, callback) {
    return promise.then((value)=>{
        ...
        $0c84690c59b4ccb2$var$invokeCallback(callback, err && err.message ? err : new Error(err));
    });
}
...
function $0c84690c59b4ccb2$var$wrapAsync(asyncFn) {
    ...
    return $0c84690c59b4ccb2$var$isAsync(asyncFn) ? $0c84690c59b4ccb2$export$b5d55b15b1db3122(asyncFn) : asyncFn;
}
    ...
    return function applyEach(fns, ...callArgs) {
        const go = $0c84690c59b4ccb2$var$awaitify(function(callback) {
            ...
            return eachfn(fns, (fn, cb)=>{
                $0c84690c59b4ccb2$var$wrapAsync(fn).apply(that, callArgs.concat(cb));
            }, callback);
        });
        return go;
    };
...
function $0c84690c59b4ccb2$var$createIterator(coll) {
    if ($0c84690c59b4ccb2$var$isArrayLike(coll)) return $0c84690c59b4ccb2$var$createArrayIterator(coll);
    var iterator = $0c84690c59b4ccb2$var$getIterator(coll);
    return iterator ? $0c84690c59b4ccb2$var$createES2015Iterator(iterator) : $0c84690c59b4ccb2$var$createObjectIterator(coll);
}
...
function $0c84690c59b4ccb2$var$asyncEachOfLimit(generator, limit, iteratee, callback) {
    let done = false;
    let canceled = false;
    let awaiting = false;
    let running = 0;
    ...
    function iterateeCallback(err, result) {
        ...
        if (result === $0c84690c59b4ccb2$var$breakLoop || done && running <= 0) {
            done = true;
...
var $0c84690c59b4ccb2$var$eachOfLimit = (limit)=>{
    return (obj, iteratee, callback)=>{
        ...
        if ($0c84690c59b4ccb2$var$isAsyncGenerator(obj)) return $0c84690c59b4ccb2$var$asyncEachOfLimit(obj, limit, iteratee, callback);
        if ($0c84690c59b4ccb2$var$isAsyncIterable(obj)) return $0c84690c59b4ccb2$var$asyncEachOfLimit(obj[Symbol.asyncIterator](), limit, iteratee, callback);
        ...
        function iterateeCallback(err, value) {
            ...
            if (err) {
                ...
                canceled = true;
            } else if (value === $0c84690c59b4ccb2$var$breakLoop || done && running <= 0) {
                done = true;
                return callback(null);
        ...
        function replenish() {
            ...
            while(running < limit && !done){
                ...
                running += 1;
                iteratee(elem.value, elem.key, $0c84690c59b4ccb2$var$onlyOnce(iterateeCallback));
            }
            looping = false;
        }
        replenish();
 ...
 */ function $0c84690c59b4ccb2$var$eachOfLimit$1(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$eachOfLimit(limit)(coll, $0c84690c59b4ccb2$var$wrapAsync(iteratee), callback);
}
var $0c84690c59b4ccb2$export$8b05461b96b91438 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$eachOfLimit$1, 4);
...
function $0c84690c59b4ccb2$var$eachOfArrayLike(coll, iteratee, callback) {
    ...
    function iteratorCallback(err, value) {
        ...
        if (err) callback(err);
        else if (++completed === length || value === $0c84690c59b4ccb2$var$breakLoop) callback(null);
    }
    for(; index < length; index++)iteratee(coll[index], index, $0c84690c59b4ccb2$var$onlyOnce(iteratorCallback));
}
// a generic version of eachOf which can handle array, object, and iterator cases.
function $0c84690c59b4ccb2$var$eachOfGeneric(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$8b05461b96b91438(coll, Infinity, iteratee, callback);
}
/**
 ...
 */ function $0c84690c59b4ccb2$var$eachOf(coll, iteratee, callback) {
    var eachOfImplementation = $0c84690c59b4ccb2$var$isArrayLike(coll) ? $0c84690c59b4ccb2$var$eachOfArrayLike : $0c84690c59b4ccb2$var$eachOfGeneric;
    return eachOfImplementation(coll, $0c84690c59b4ccb2$var$wrapAsync(iteratee), callback);
}
var $0c84690c59b4ccb2$export$d10d68e43a57bce9 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$eachOf, 3);
/**
 ...
 */ function $0c84690c59b4ccb2$var$map(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_asyncMap($0c84690c59b4ccb2$export$d10d68e43a57bce9, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$871de8747c9eaa88 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$map, 3);
/**
 ...
 *     callback
 * );
 */ var $0c84690c59b4ccb2$export$e0fc6250e304edaf = $0c84690c59b4ccb2$var$applyEach($0c84690c59b4ccb2$export$871de8747c9eaa88);
/**
 ...
 */ function $0c84690c59b4ccb2$var$eachOfSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$8b05461b96b91438(coll, 1, iteratee, callback);
}
var $0c84690c59b4ccb2$export$750e7e5fea3b0654 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$eachOfSeries, 3);
/**
 ...
 */ function $0c84690c59b4ccb2$var$mapSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_asyncMap($0c84690c59b4ccb2$export$750e7e5fea3b0654, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$9a85c32cda85b0dd = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$mapSeries, 3);
/**
 ...
 * a callback.
 */ var $0c84690c59b4ccb2$export$cdb63afc167779e = $0c84690c59b4ccb2$var$applyEach($0c84690c59b4ccb2$export$9a85c32cda85b0dd);
 ...
 * }
 *
 */ function $0c84690c59b4ccb2$export$dfb5619354ba860(tasks, concurrency, callback) {
    if (typeof concurrency !== "number") {
        // concurrency is optional, shift the args.
        callback = concurrency;
        concurrency = null;
    }
    callback = $0c84690c59b4ccb2$var$once(callback || $0c84690c59b4ccb2$var$promiseCallback());
...
var $0c84690c59b4ccb2$var$FN_ARGS = /^(?:async\s+)?(?:function)?\s*\w*\s*\(\s*([^)]+)\s*\)(?:\s*{)/;
var $0c84690c59b4ccb2$var$ARROW_FN_ARGS = /^(?:async\s+)?\(?\s*([^)=]+)\s*\)?(?:\s*=>)/;
...
function $0c84690c59b4ccb2$var$parseParams(func) {
    ...
    let [, args] = match;
    return args.replace(/\s/g, "").split($0c84690c59b4ccb2$var$FN_ARG_SPLIT).map((arg)=>arg.replace($0c84690c59b4ccb2$var$FN_ARG, "").trim());
}
/**
 ...
 * });
 */ function $0c84690c59b4ccb2$export$687de40d137ed486(worker, concurrency, payload) {
 ...
 */ function $0c84690c59b4ccb2$var$reduce(coll, memo, iteratee, callback) {
    callback = $0c84690c59b4ccb2$var$once(callback);
    var _iteratee = $0c84690c59b4ccb2$var$wrapAsync(iteratee);
    return $0c84690c59b4ccb2$export$750e7e5fea3b0654(coll, (x, i, iterCb)=>{
...
var $0c84690c59b4ccb2$export$533b26079ad0b4b = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$reduce, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$export$1041d4276c328e4d(...functions) {
    ...
    return function(...args) {
        ...
        $0c84690c59b4ccb2$export$533b26079ad0b4b(_functions, args, (newargs, fn, iterCb)=>{
 ...
 */ function $0c84690c59b4ccb2$var$mapLimit(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_asyncMap($0c84690c59b4ccb2$var$eachOfLimit(limit), coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$6a28d19bcc59197c = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$mapLimit, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$concatLimit(coll, limit, iteratee, callback) {
    var _iteratee = $0c84690c59b4ccb2$var$wrapAsync(iteratee);
    return $0c84690c59b4ccb2$export$6a28d19bcc59197c(coll, limit, (val, iterCb)=>{
...
var $0c84690c59b4ccb2$export$4f1520afe59a31db = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$concatLimit, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$concat(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$4f1520afe59a31db(coll, Infinity, iteratee, callback);
}
var $0c84690c59b4ccb2$export$ee1b3e54f0441b22 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$concat, 3);
/**
 ...
 */ function $0c84690c59b4ccb2$var$concatSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$4f1520afe59a31db(coll, 1, iteratee, callback);
}
var $0c84690c59b4ccb2$export$b6df61d74da01b63 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$concatSeries, 3);
/**
 ...
 */ function $0c84690c59b4ccb2$var$detect(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester((bool)=>bool, (res, item)=>item)($0c84690c59b4ccb2$export$d10d68e43a57bce9, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$17b446b869dad473 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$detect, 3);
/**
 ...
 * (err, result).
 * @returns {Promise} a promise, if a callback is omitted
 */ function $0c84690c59b4ccb2$var$detectLimit(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester((bool)=>bool, (res, item)=>item)($0c84690c59b4ccb2$var$eachOfLimit(limit), coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$922bcf02f3a5b284 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$detectLimit, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$detectSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester((bool)=>bool, (res, item)=>item)($0c84690c59b4ccb2$var$eachOfLimit(1), coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$922a9a31d0cff2ee = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$detectSeries, 3);
function $0c84690c59b4ccb2$var$consoleFunc(name) {
    return (fn, ...args)=>$0c84690c59b4ccb2$var$wrapAsync(fn)(...args, (err, ...resultArgs)=>{
 ...
 * {hello: 'world'}
 */ var $0c84690c59b4ccb2$export$147ec2801e896265 = $0c84690c59b4ccb2$var$consoleFunc("dir");
/**
...
var $0c84690c59b4ccb2$export$353f40bf1add0d75 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$doWhilst, 3);
/**
 ...
 * @returns {Promise} a promise, if no callback is passed
 */ function $0c84690c59b4ccb2$export$16f3a0560cc13fb4(iteratee, test, callback) {
    const _test = $0c84690c59b4ccb2$var$wrapAsync(test);
    return $0c84690c59b4ccb2$export$353f40bf1add0d75(iteratee, (...args)=>{
        const cb = args.pop();
 ...
 */ function $0c84690c59b4ccb2$var$eachLimit(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$d10d68e43a57bce9(coll, $0c84690c59b4ccb2$var$_withoutIndex($0c84690c59b4ccb2$var$wrapAsync(iteratee)), callback);
}
var $0c84690c59b4ccb2$export$79b2f7037acddd43 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$eachLimit, 3);
/**
 ...
 * `iteratee` functions have finished, or an error occurs. Invoked with (err).
 * @returns {Promise} a promise, if a callback is omitted
 */ function $0c84690c59b4ccb2$var$eachLimit$1(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$eachOfLimit(limit)(coll, $0c84690c59b4ccb2$var$_withoutIndex($0c84690c59b4ccb2$var$wrapAsync(iteratee)), callback);
}
var $0c84690c59b4ccb2$export$2a2080ddac50d6b8 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$eachLimit$1, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$eachSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$2a2080ddac50d6b8(coll, 1, iteratee, callback);
}
var $0c84690c59b4ccb2$export$9bd663f1fadd104c = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$eachSeries, 3);
/**
 ...
 */ function $0c84690c59b4ccb2$export$85d5b9ccf228381c(fn) {
    ...
    return function(...args /*, callback*/ ) {
        ...
        var sync = true;
        args.push((...innerArgs)=>{
            if (sync) $0c84690c59b4ccb2$export$c233f08fbfea0913(()=>callback(...innerArgs));
 ...
 */ function $0c84690c59b4ccb2$var$every(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester((bool)=>!bool, (res)=>!res)($0c84690c59b4ccb2$export$d10d68e43a57bce9, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$7ecc1a3b11b57dab = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$every, 3);
/**
 ...
 * depending on the values of the async tests. Invoked with (err, result).
 * @returns {Promise} a promise, if no callback provided
 */ function $0c84690c59b4ccb2$var$everyLimit(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester((bool)=>!bool, (res)=>!res)($0c84690c59b4ccb2$var$eachOfLimit(limit), coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$61377f8da40b9b4c = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$everyLimit, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$everySeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester((bool)=>!bool, (res)=>!res)($0c84690c59b4ccb2$export$750e7e5fea3b0654, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$7ce9462b07c48a66 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$everySeries, 3);
...
function $0c84690c59b4ccb2$var$filterGeneric(eachfn, coll, iteratee, callback) {
    var results = [];
...
function $0c84690c59b4ccb2$var$_filter(eachfn, coll, iteratee, callback) {
    var filter = $0c84690c59b4ccb2$var$isArrayLike(coll) ? $0c84690c59b4ccb2$var$filterArray : $0c84690c59b4ccb2$var$filterGeneric;
    return filter(eachfn, coll, $0c84690c59b4ccb2$var$wrapAsync(iteratee), callback);
}
/**
 ...
 */ function $0c84690c59b4ccb2$var$filter(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_filter($0c84690c59b4ccb2$export$d10d68e43a57bce9, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$3dea766d36a8935f = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$filter, 3);
/**
 ...
 * `iteratee` functions have finished. Invoked with (err, results).
 * @returns {Promise} a promise, if no callback provided
 */ function $0c84690c59b4ccb2$var$filterLimit(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_filter($0c84690c59b4ccb2$var$eachOfLimit(limit), coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$6a93acd3681313ac = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$filterLimit, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$filterSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_filter($0c84690c59b4ccb2$export$750e7e5fea3b0654, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$ddcc38daaa46257c = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$filterSeries, 3);
/**
 ...
 */ function $0c84690c59b4ccb2$var$forever(fn, errback) {
    ...
    var task = $0c84690c59b4ccb2$var$wrapAsync($0c84690c59b4ccb2$export$85d5b9ccf228381c(fn));
    function next(err) {
...
var $0c84690c59b4ccb2$export$116a0f7f2303acd8 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$forever, 2);
/**
 ...
 * @returns {Promise} a promise, if no callback is passed
 */ function $0c84690c59b4ccb2$var$groupByLimit(coll, limit, iteratee, callback) {
    var _iteratee = $0c84690c59b4ccb2$var$wrapAsync(iteratee);
    return $0c84690c59b4ccb2$export$6a28d19bcc59197c(coll, limit, (val, iterCb)=>{
...
var $0c84690c59b4ccb2$export$335ad4c8e8977a4b = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$groupByLimit, 4);
/**
 ...
 * }
 *
 */ function $0c84690c59b4ccb2$export$3f063810d7bf01bd(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$335ad4c8e8977a4b(coll, Infinity, iteratee, callback);
}
/**
 ...
 * properties are arrays of values which returned the corresponding key.
 * @returns {Promise} a promise, if no callback is passed
 */ function $0c84690c59b4ccb2$export$d0689f2b629adbdb(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$export$335ad4c8e8977a4b(coll, 1, iteratee, callback);
}
/**
 ...
 * 'hello world'
 */ var $0c84690c59b4ccb2$export$bef1f36f5486a6a3 = $0c84690c59b4ccb2$var$consoleFunc("log");
/**
 ...
 * @returns {Promise} a promise, if no callback is passed
 */ function $0c84690c59b4ccb2$var$mapValuesLimit(obj, limit, iteratee, callback) {
    callback = $0c84690c59b4ccb2$var$once(callback);
    var newObj = {};
    var _iteratee = $0c84690c59b4ccb2$var$wrapAsync(iteratee);
    return $0c84690c59b4ccb2$var$eachOfLimit(limit)(obj, (val, key, next)=>{
...
var $0c84690c59b4ccb2$export$d5d82430c6fa645f = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$mapValuesLimit, 4);
/**
 ...
 * }
 *
 */ function $0c84690c59b4ccb2$export$825e789796ab7275(obj, iteratee, callback) {
    return $0c84690c59b4ccb2$export$d5d82430c6fa645f(obj, Infinity, iteratee, callback);
}
/**
 ...
 * Invoked with (err, result).
 * @returns {Promise} a promise, if no callback is passed
 */ function $0c84690c59b4ccb2$export$8fbd16e43ec40b44(obj, iteratee, callback) {
    return $0c84690c59b4ccb2$export$d5d82430c6fa645f(obj, 1, iteratee, callback);
}
/**
 ...
 *     // callback
 * });
 */ function $0c84690c59b4ccb2$export$fc10aeed3a532e2a(fn, hasher = (v)=>v) {
    var memo = Object.create(null);
    var queues = Object.create(null);
    var _fn = $0c84690c59b4ccb2$var$wrapAsync(fn);
    var memoized = $0c84690c59b4ccb2$var$initialParams((args, callback)=>{
        var key = hasher(...args);
        if (key in memo) $0c84690c59b4ccb2$export$c233f08fbfea0913(()=>callback(null, ...memo[key]));
...
if ($0c84690c59b4ccb2$var$hasNextTick) $0c84690c59b4ccb2$var$_defer$1 = $bFvJb$process.nextTick;
else if ($0c84690c59b4ccb2$var$hasSetImmediate) $0c84690c59b4ccb2$var$_defer$1 = setImmediate;
else $0c84690c59b4ccb2$var$_defer$1 = $0c84690c59b4ccb2$var$fallback;
var $0c84690c59b4ccb2$export$bdd553fddd433dcb = $0c84690c59b4ccb2$var$wrap($0c84690c59b4ccb2$var$_defer$1);
var $0c84690c59b4ccb2$var$parallel = $0c84690c59b4ccb2$var$awaitify((eachfn, tasks, callback)=>{
 ...
 */ function $0c84690c59b4ccb2$export$451942af9381149c(tasks, callback) {
    return $0c84690c59b4ccb2$var$parallel($0c84690c59b4ccb2$export$d10d68e43a57bce9, tasks, callback);
}
/**
 ...
 * Invoked with (err, results).
 * @returns {Promise} a promise, if a callback is not passed
 */ function $0c84690c59b4ccb2$export$362c0a688af131a0(tasks, limit, callback) {
    return $0c84690c59b4ccb2$var$parallel($0c84690c59b4ccb2$var$eachOfLimit(limit), tasks, callback);
}
/**
 ...
 */ function $0c84690c59b4ccb2$export$4f7fa46ff53e516f(worker, concurrency) {
    var _worker = $0c84690c59b4ccb2$var$wrapAsync(worker);
    return $0c84690c59b4ccb2$var$queue((items, cb)=>{
        _worker(items[0], cb);
    }, concurrency, 1);
}
...
class $0c84690c59b4ccb2$var$Heap {
    ...
    percUp(index) {
        let p;
        while(index > 0 && $0c84690c59b4ccb2$var$smaller(this.heap[index], this.heap[p = $0c84690c59b4ccb2$var$parent(index)])){
    ...
    percDown(index) {
        ...
        while((l = $0c84690c59b4ccb2$var$leftChi(index)) < this.heap.length){
            if (l + 1 < this.heap.length && $0c84690c59b4ccb2$var$smaller(this.heap[l + 1], this.heap[l])) l = l + 1;
            if ($0c84690c59b4ccb2$var$smaller(this.heap[index], this.heap[l])) break;
            let t = this.heap[index];
    ...
    *[Symbol.iterator]() {
    ...
    remove(testFn) {
        ...
        this.heap.splice(j);
        for(let i = $0c84690c59b4ccb2$var$parent(this.heap.length - 1); i >= 0; i--)this.percDown(i);
        return this;
    }
}
 ...
 */ function $0c84690c59b4ccb2$var$race(tasks, callback) {
    ...
    for(var i = 0, l = tasks.length; i < l; i++)$0c84690c59b4ccb2$var$wrapAsync(tasks[i])(callback);
}
var $0c84690c59b4ccb2$export$236c05de452bec2 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$race, 2);
/**
 ...
 * (err, result).
 * @returns {Promise} a promise, if no callback is passed
 */ function $0c84690c59b4ccb2$export$7fef8bcdbb34f435(array, memo, iteratee, callback) {
    var reversed = [
        ...array
    ].reverse();
    return $0c84690c59b4ccb2$export$533b26079ad0b4b(reversed, memo, iteratee, callback);
}
/**
 ...
 */ function $0c84690c59b4ccb2$export$9debe8cffacea23(fn) {
    var _fn = $0c84690c59b4ccb2$var$wrapAsync(fn);
    return $0c84690c59b4ccb2$var$initialParams(function reflectOn(args, reflectCallback) {
 ...
 */ function $0c84690c59b4ccb2$export$1a54554d0a489acc(tasks) {
    var results;
    if (Array.isArray(tasks)) results = tasks.map($0c84690c59b4ccb2$export$9debe8cffacea23);
    else {
        results = {};
        Object.keys(tasks).forEach((key)=>{
            results[key] = $0c84690c59b4ccb2$export$9debe8cffacea23.call(this, tasks[key]);
        });
    }
    return results;
}
function $0c84690c59b4ccb2$var$reject(eachfn, arr, _iteratee, callback) {
    const iteratee = $0c84690c59b4ccb2$var$wrapAsync(_iteratee);
    return $0c84690c59b4ccb2$var$_filter(eachfn, arr, (value, cb)=>{
 ...
 */ function $0c84690c59b4ccb2$var$reject$1(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$reject($0c84690c59b4ccb2$export$d10d68e43a57bce9, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$2800f3ceda99eb84 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$reject$1, 3);
/**
 ...
 * `iteratee` functions have finished. Invoked with (err, results).
 * @returns {Promise} a promise, if no callback is passed
 */ function $0c84690c59b4ccb2$var$rejectLimit(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$reject($0c84690c59b4ccb2$var$eachOfLimit(limit), coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$b59d647fa1894da8 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$rejectLimit, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$rejectSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$reject($0c84690c59b4ccb2$export$750e7e5fea3b0654, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$d68373657532124d = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$rejectSeries, 3);
...
function $0c84690c59b4ccb2$export$9369b12211e1fce4(opts, task, callback) {
    var options = {
        ...
        intervalFunc: $0c84690c59b4ccb2$var$constant$1($0c84690c59b4ccb2$var$DEFAULT_INTERVAL)
    };
...
function $0c84690c59b4ccb2$var$parseTimes(acc, t) {
    if (typeof t === "object") {
        ...
        acc.intervalFunc = typeof t.interval === "function" ? t.interval : $0c84690c59b4ccb2$var$constant$1(+t.interval || $0c84690c59b4ccb2$var$DEFAULT_INTERVAL);
        acc.errorFilter = t.errorFilter;
    } else if (typeof t === "number" || typeof t === "string") acc.times = +t || $0c84690c59b4ccb2$var$DEFAULT_TIMES;
 ...
 */ function $0c84690c59b4ccb2$export$9e1b8e833f44ff21(opts, task) {
    ...
    return $0c84690c59b4ccb2$var$initialParams((args, callback)=>{
        ...
        if (opts) $0c84690c59b4ccb2$export$9369b12211e1fce4(opts, taskFn, callback);
 ...
 */ function $0c84690c59b4ccb2$export$7589597339a0562d(tasks, callback) {
    return $0c84690c59b4ccb2$var$parallel($0c84690c59b4ccb2$export$750e7e5fea3b0654, tasks, callback);
}
/**
 ...
 */ function $0c84690c59b4ccb2$var$some(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester(Boolean, (res)=>res)($0c84690c59b4ccb2$export$d10d68e43a57bce9, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$ad14ef4001db2bcd = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$some, 3);
/**
 ...
 * tests. Invoked with (err, result).
 * @returns {Promise} a promise, if no callback provided
 */ function $0c84690c59b4ccb2$var$someLimit(coll, limit, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester(Boolean, (res)=>res)($0c84690c59b4ccb2$var$eachOfLimit(limit), coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$eb635e263b5ded90 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$someLimit, 4);
/**
 ...
 */ function $0c84690c59b4ccb2$var$someSeries(coll, iteratee, callback) {
    return $0c84690c59b4ccb2$var$_createTester(Boolean, (res)=>res)($0c84690c59b4ccb2$export$750e7e5fea3b0654, coll, iteratee, callback);
}
var $0c84690c59b4ccb2$export$c072acdb5b2ad89 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$someSeries, 3);
/**
 ...
 */ function $0c84690c59b4ccb2$var$sortBy(coll, iteratee, callback) {
    var _iteratee = $0c84690c59b4ccb2$var$wrapAsync(iteratee);
    return $0c84690c59b4ccb2$export$871de8747c9eaa88(coll, (x, iterCb)=>{
...
var $0c84690c59b4ccb2$export$b035e44d7bb4278f = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$sortBy, 3);
/**
 ...
 * });
 */ function $0c84690c59b4ccb2$export$83e74882c5df8fe1(asyncFn, milliseconds, info) {
 ...
 */ function $0c84690c59b4ccb2$export$5ebd4c84811c422b(count, limit, iteratee, callback) {
    var _iteratee = $0c84690c59b4ccb2$var$wrapAsync(iteratee);
    return $0c84690c59b4ccb2$export$6a28d19bcc59197c($0c84690c59b4ccb2$var$range(count), limit, _iteratee, callback);
}
/**
 ...
 * });
 */ function $0c84690c59b4ccb2$export$b5bc26e198ce73d0(n, iteratee, callback) {
    return $0c84690c59b4ccb2$export$5ebd4c84811c422b(n, Infinity, iteratee, callback);
}
/**
 ...
 * @param {Function} callback - see {@link module:Collections.map}.
 * @returns {Promise} a promise, if no callback is provided
 */ function $0c84690c59b4ccb2$export$51c3f8bb1fe6838c(n, iteratee, callback) {
 ...
 * }
 *
 */ function $0c84690c59b4ccb2$export$51186ad6e864892a(coll, accumulator, iteratee, callback) {
    ...
    callback = $0c84690c59b4ccb2$var$once(callback || $0c84690c59b4ccb2$var$promiseCallback());
    var _iteratee = $0c84690c59b4ccb2$var$wrapAsync(iteratee);
    $0c84690c59b4ccb2$export$d10d68e43a57bce9(coll, (v, k, cb)=>{
 ...
 */ function $0c84690c59b4ccb2$var$tryEach(tasks, callback) {
    var error = null;
    var result;
    return $0c84690c59b4ccb2$export$9bd663f1fadd104c(tasks, (task, taskCb)=>{
...
var $0c84690c59b4ccb2$export$c382910393876e1e = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$tryEach);
/**
...
var $0c84690c59b4ccb2$export$da38dd6790b15d8f = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$whilst, 3);
/**
 ...
 * })
 */ function $0c84690c59b4ccb2$export$a40009bd2c363351(test, iteratee, callback) {
    const _test = $0c84690c59b4ccb2$var$wrapAsync(test);
    return $0c84690c59b4ccb2$export$da38dd6790b15d8f((cb)=>_test((err, truth)=>cb(err, !truth)), iteratee, callback);
}
/**
...
var $0c84690c59b4ccb2$export$981f466e0ef96280 = $0c84690c59b4ccb2$var$awaitify($0c84690c59b4ccb2$var$waterfall);
/**
...
/*
 *! Capability helpers
 */ var $fbe0c5f28b372c17$var$avCodecRegexp = /^\s*([D ])([E ])([VAS])([S ])([D ])([T ]) ([^ ]+) +(.*)$/;
var $fbe0c5f28b372c17$var$ffCodecRegexp = /^\s*([D\.])([E\.])([VAS])([I\.])([L\.])([S\.]) ([^ ]+) +(.*)$/;
var $fbe0c5f28b372c17$var$ffEncodersRegexp = /\(encoders:([^\)]+)\)/;
var $fbe0c5f28b372c17$var$ffDecodersRegexp = /\(decoders:([^\)]+)\)/;
var $fbe0c5f28b372c17$var$encodersRegexp = /^\s*([VAS\.])([F\.])([S\.])([X\.])([B\.])([D\.]) ([^ ]+) +(.*)$/;
var $fbe0c5f28b372c17$var$formatRegexp = /^\s*([D ])([E ]) ([^ ]+) +(.*)$/;
var $fbe0c5f28b372c17$var$lineBreakRegexp = /\r\n|\r|\n/;
var $fbe0c5f28b372c17$var$filterRegexp = /^(?: [T\.][S\.][C\.] )?([^ ]+) +(AA?|VV?|\|)->(AA?|VV?|\|) +(.*)$/;
...
module.exports = function(proto) {
   ...
   */ proto._getFfmpegPath = function(callback) {
        if ("ffmpegPath" in $fbe0c5f28b372c17$var$cache) return callback(null, $fbe0c5f28b372c17$var$cache.ffmpegPath);
        $aK4hl.waterfall([
            // Try FFMPEG_PATH
            function(cb) {
                cb(null, "");
            ...
            if (err) callback(err);
            else callback(null, $fbe0c5f28b372c17$var$cache.ffmpegPath = ffmpeg || "");
        });
    };
    /**
   ...
   */ proto._getFfprobePath = function(callback) {
        var self = this;
        if ("ffprobePath" in $fbe0c5f28b372c17$var$cache) return callback(null, $fbe0c5f28b372c17$var$cache.ffprobePath);
        $aK4hl.waterfall([
            // Try FFPROBE_PATH
            function(cb) {
                cb(null, "");
            ...
            function(ffprobe, cb) {
                ...
                self._getFfmpegPath(function(err, ffmpeg) {
                    if (err) cb(err);
                        ...
                        var ffprobe = $bFvJb$path.join($bFvJb$path.dirname(ffmpeg), name);
            ...
            if (err) callback(err);
            else callback(null, $fbe0c5f28b372c17$var$cache.ffprobePath = ffprobe || "");
        });
    };
    /**
   ...
   */ proto._getFlvtoolPath = function(callback) {
        if ("flvtoolPath" in $fbe0c5f28b372c17$var$cache) return callback(null, $fbe0c5f28b372c17$var$cache.flvtoolPath);
        $aK4hl.waterfall([
            // Try FLVMETA_PATH
            function(cb) {
                cb(null, "");
            ...
            if (err) callback(err);
            else callback(null, $fbe0c5f28b372c17$var$cache.flvtoolPath = flvtool || "");
        });
    };
    /**
   ...
   */ proto.availableFilters = proto.getAvailableFilters = function(callback) {
        if ("filters" in $fbe0c5f28b372c17$var$cache) return callback(null, $fbe0c5f28b372c17$var$cache.filters);
        this._spawnFfmpeg([
            "-filters"
        ], {
            captureStdout: true,
   ...
   */ proto.availableCodecs = proto.getAvailableCodecs = function(callback) {
        if ("codecs" in $fbe0c5f28b372c17$var$cache) return callback(null, $fbe0c5f28b372c17$var$cache.codecs);
        this._spawnFfmpeg([
            "-codecs"
        ], {
            captureStdout: true,
            ...
            lines.forEach(function(line) {
                ...
                if (match && match[7] !== "=") {
                    ...
                    var encoders = codecData.description.match($fbe0c5f28b372c17$var$ffEncodersRegexp);
                    encoders = encoders ? encoders[1].trim().split(" ") : [];
                    var decoders = codecData.description.match($fbe0c5f28b372c17$var$ffDecodersRegexp);
   ...
   */ proto.availableEncoders = proto.getAvailableEncoders = function(callback) {
        if ("encoders" in $fbe0c5f28b372c17$var$cache) return callback(null, $fbe0c5f28b372c17$var$cache.encoders);
        this._spawnFfmpeg([
            "-encoders"
        ], {
            captureStdout: true,
   ...
   */ proto.availableFormats = proto.getAvailableFormats = function(callback) {
        if ("formats" in $fbe0c5f28b372c17$var$cache) return callback(null, $fbe0c5f28b372c17$var$cache.formats);
        // Run ffmpeg -formats
        this._spawnFfmpeg([
            "-formats"
        ], {
            ...
            lines.forEach(function(line) {
                ...
                if (match) match[3].split(",").forEach(function(format) {
        ...
        $aK4hl.waterfall([
            ...
            function(formats, cb) {
                ...
                unavailable = self._outputs.reduce(function(fmts, output) {
                    ...
                    if (format) {
                        if (!(format[0] in formats) || !formats[format[0]].canMux) fmts.push(format);
                    }
                    return fmts;
                }, []);
                if (unavailable.length === 1) return cb(new Error("Output format " + unavailable[0] + " is not available"));
                else if (unavailable.length > 1) return cb(new Error("Output formats " + unavailable.join(", ") + " are not available"));
                // Input format(s)
                unavailable = self._inputs.reduce(function(fmts, input) {
                    var format = input.options.find("-f", 1);
                    if (format) {
                        if (!(format[0] in formats) || !formats[format[0]].canDemux) fmts.push(format[0]);
                    }
                    return fmts;
                }, []);
                if (unavailable.length === 1) return cb(new Error("Input format " + unavailable[0] + " is not available"));
                else if (unavailable.length > 1) return cb(new Error("Input formats " + unavailable.join(", ") + " are not available"));
                cb();
            },
            ...
            function(encoders, cb) {
                ...
                unavailable = self._outputs.reduce(function(cdcs, output) {
                    ...
                    if (acodec && acodec[0] !== "copy") {
                        if (!(acodec[0] in encoders) || encoders[acodec[0]].type !== "audio") cdcs.push(acodec[0]);
                    }
                    return cdcs;
                }, []);
                if (unavailable.length === 1) return cb(new Error("Audio codec " + unavailable[0] + " is not available"));
                else if (unavailable.length > 1) return cb(new Error("Audio codecs " + unavailable.join(", ") + " are not available"));
                // Video codec(s)
                unavailable = self._outputs.reduce(function(cdcs, output) {
                    var vcodec = output.video.find("-vcodec", 1);
                    if (vcodec && vcodec[0] !== "copy") {
                        if (!(vcodec[0] in encoders) || encoders[vcodec[0]].type !== "video") cdcs.push(vcodec[0]);
                    }
                    return cdcs;
                }, []);
                if (unavailable.length === 1) return cb(new Error("Video codec " + unavailable[0] + " is not available"));
                else if (unavailable.length > 1) return cb(new Error("Video codecs " + unavailable.join(", ") + " are not available"));
                cb();
            }
        ], callback);
    };
...
function $2034b945367a7922$var$parseFfprobeOutput(out) {
    ...
    function parseBlock(name) {
        ...
        while(typeof line !== "undefined"){
            ...
            var kv = line.match(/^([^=]+)=(.*)$/);
            if (kv) {
                if (!kv[1].match(/^TAG:/) && kv[2].match(/^[0-9]+(\.[0-9]+)?$/)) data[kv[1]] = Number(kv[2]);
                else data[kv[1]] = kv[2];
            }
            line = lines.shift();
        }
    ...
    while(typeof line !== "undefined"){
        ...
        } else if (line.toLowerCase() === "[format]") data.format = parseBlock("format");
        line = lines.shift();
    }
    return data;
}
module.exports = function(proto) {
   ...
   */ proto.ffprobe = function() {
        ...
        if (index === null) {
            if (!this._currentInput) return handleCallback(new Error("No input specified"));
        ...
        this._getFfprobePath(function(err, path) {
            ...
            var ffprobe = $2034b945367a7922$require$spawn(path, [
                "-show_streams",
                "-show_format"
            ].concat(options, src));
            if (input.isStream) {
            ...
            function handleExit(err) {
                ...
                if (processExited && stdoutClosed && stderrClosed) {
                    ...
                    [
                        ...
                        if (target) {
                            var legacyTagKeys = Object.keys(target).filter($2034b945367a7922$var$legacyTag);
                            ...
                            var legacyDispositionKeys = Object.keys(target).filter($2034b945367a7922$var$legacyDisposition);
 ...
 */ module.exports = function recipes(proto) {
   ...
   */ proto.writeToStream = proto.pipe = proto.stream = function(stream, options) {
        ...
        if (!stream) {
            if ($bFvJb$process.version.match(/v0\.8\./)) throw new Error("PassThrough stream is not supported on node v0.8");
   ...
   */ proto.takeScreenshots = proto.thumbnail = proto.thumbnails = proto.screenshot = proto.screenshots = function(config, folder) {
        ...
        if (!("timemarks" in config)) {
            if (!config.count) throw new Error("Cannot take screenshots: neither a count nor a timemark list are specified");
            var interval = 100 / (1 + config.count);
            config.timemarks = [];
            for(var i = 0; i < config.count; i++)config.timemarks.push(interval * (i + 1) + "%");
        }
        // Parse size option
        if ("size" in config) {
            ...
            if (!fixedSize && !fixedWidth && !fixedHeight && !percentSize) throw new Error("Invalid size parameter: " + config.size);
        }
        // Metadata helper
        var metadata;
        function getMetadata(cb) {
            if (metadata) cb(null, metadata);
            else self.ffprobe(function(err, meta) {
                metadata = meta;
                cb(err, meta);
            });
        }
        $aK4hl.waterfall([
            ...
            function computeTimemarks(next) {
                if (config.timemarks.some(function(t) {
                    ...
                    if (typeof source !== "string") return next(new Error("Cannot compute screenshot timemarks with an input stream, please specify fixed timemarks"));
                    getMetadata(function(err, meta) {
                        if (err) next(err);
                        else {
                            // Select video stream with the highest resolution
                            var vstream = meta.streams.reduce(function(biggest, stream) {
                                if (stream.codec_type === "video" && stream.width * stream.height > biggest.width * biggest.height) return stream;
                                else return biggest;
                            }, {
                                width: 0,
                                height: 0
                            });
                            if (vstream.width === 0) return next(new Error("No video stream in input, cannot take screenshots"));
                            var duration = Number(vstream.duration);
                            if (isNaN(duration)) duration = Number(meta.format.duration);
                            if (isNaN(duration)) return next(new Error("Could not get input duration, please specify fixed timemarks"));
                            config.timemarks = config.timemarks.map(function(mark) {
                                if (("" + mark).match(/^([\d.]+)%$/)) return duration * parseFloat(mark) / 100;
                                else return mark;
                            });
                            next();
                        }
            ...
            function fixPattern(next) {
                ...
                if (config.timemarks.length > 1 && !pattern.match(/%(s|0*i)/)) {
                    ...
                    pattern = $bFvJb$path.join($bFvJb$path.dirname(pattern), $bFvJb$path.basename(pattern, ext) + "_%i" + ext);
                }
                next(null, pattern);
            },
            ...
            function replaceFilenameTokens(pattern, next) {
                if (pattern.match(/%[bf]/)) {
                    if (typeof source !== "string") return next(new Error("Cannot replace %f or %b when using an input stream"));
                    pattern = pattern.replace(/%f/g, $bFvJb$path.basename(source)).replace(/%b/g, $bFvJb$path.basename(source, $bFvJb$path.extname(source)));
                }
                next(null, pattern);
            },
            ...
            function getSize(pattern, next) {
                if (pattern.match(/%[whr]/)) {
                    if (fixedSize) return next(null, pattern, fixedSize[1], fixedSize[2]);
                    getMetadata(function(err, meta) {
                        if (err) return next(new Error("Could not determine video resolution to replace %w, %h or %r"));
                        var vstream = meta.streams.reduce(function(biggest, stream) {
                            if (stream.codec_type === "video" && stream.width * stream.height > biggest.width * biggest.height) return stream;
                            else return biggest;
                        }, {
                        ...
                        if (vstream.width === 0) return next(new Error("No video stream in input, cannot replace %w, %h or %r"));
            ...
            function replaceVariableTokens(pattern, next) {
                var filenames = config.timemarks.map(function(t, i) {
                    return pattern.replace(/%s/g, $gOWQU.timemarkToSeconds(t)).replace(/%(0*)i/g, function(match, padding) {
                        var idx = "" + (i + 1);
            ...
            function createDirectory(filenames, next) {
                $bFvJb$fs.exists(config.folder, function(exists) {
                    if (!exists) $bFvJb$fs.mkdir(config.folder, function(err) {
                        if (err) next(err);
            ...
            for(var i = 0; i < count; i++){
                ...
                self.output($bFvJb$path.join(config.folder, filenames[i])).frames(1).map(stream);
...
var $4fa2282f8319e510$exports = {};

var $2b42f58907b10e9c$exports = {};

$2b42f58907b10e9c$exports = (parcelRequire("eyyP1"));


var $4fa2282f8319e510$var$allowedProperties = [
    "fields",
    "channelId",
    "channelType",
    "eventType",
...
$4fa2282f8319e510$exports = function search(term, opts, cb) {
    ...
    Object.keys(opts).map(function(k) {
        if ($4fa2282f8319e510$var$allowedProperties.indexOf(k) > -1) params[k] = opts[k];
    });
    $2b42f58907b10e9c$exports.get("https://www.googleapis.com/youtube/v3/search?" + $bFvJb$querystring.stringify(params)).then(function(response) {
...
const $383e46f26d360885$var$exec = $bFvJb$util.promisify($bFvJb$child_process.exec);
...
$9e487c419ed1bfee$export$beb63bc92c294b1d = (mixedJson)=>{
    ...
    for(i = 0; i < mixedJson.length; i++){
        ...
        if (counter === 0) // Return the cut JSON
        return mixedJson.substring(0, i + 1);
    }
    // We ran through the whole string and ended up with an unclosed bracket
    throw Error("Can't cut unsupported JSON (no matching closing bracket found)");
};
$9e487c419ed1bfee$export$8d19b782e6cae425 = (player_response, statuses, ErrorType = Error)=>{
    let playability = player_response && player_response.playabilityStatus;
    if (playability && statuses.includes(playability.status)) return new ErrorType(playability.reason || playability.messages && playability.messages[0]);
    return null;
};
$9e487c419ed1bfee$export$cbbbf91b85781804 = (url, options = {}, requestOptionsOverwrite)=>{
...
$9e487c419ed1bfee$export$b680e6b2c82f8c2f = (obj, prop, value, oldPath, newPath)=>{
...
$9e487c419ed1bfee$export$2e6670267debbbbd = ()=>{
    if (!$8ZGq3.version.startsWith("0.0.0-") && Date.now() - $9e487c419ed1bfee$export$6ccd8c5da0dcc4f >= $9e487c419ed1bfee$var$UPDATE_INTERVAL) {
        $9e487c419ed1bfee$export$6ccd8c5da0dcc4f = Date.now();
        return $7XA7f("https://api.github.com/repos/fent/node-ytdl-core/releases/latest", {
            headers: {
                "User-Agent": "ytdl-core"
            }
        }).text().then((response)=>{
            if (JSON.parse(response).tag_name !== `v${$8ZGq3.version}`) console.warn('\x1b[33mWARNING:\x1b[0m ytdl-core is out of date! Update with "npm install ytdl-core@latest".');
        }, (err)=>{
...
const $9e487c419ed1bfee$var$IPV6_REGEX = /^(([0-9a-f]{1,4}:)(:[0-9a-f]{1,4}){1,6}|([0-9a-f]{1,4}:){1,2}(:[0-9a-f]{1,4}){1,5}|([0-9a-f]{1,4}:){1,3}(:[0-9a-f]{1,4}){1,4}|([0-9a-f]{1,4}:){1,4}(:[0-9a-f]{1,4}){1,3}|([0-9a-f]{1,4}:){1,5}(:[0-9a-f]{1,4}){1,2}|([0-9a-f]{1,4}:){1,6}(:[0-9a-f]{1,4})|([0-9a-f]{1,4}:){1,7}(([0-9a-f]{1,4})|:))\/(1[0-1]\d|12[0-8]|\d{1,2})$/;
/**
 ...
 */ const $9e487c419ed1bfee$var$isIPv6 = $9e487c419ed1bfee$export$d8edbef20cc36333 = (ip)=>$9e487c419ed1bfee$var$IPV6_REGEX.test(ip);
/**
 * Normalise an IP Address
 *
 * @param {string} ip the IPv6 Addr
 * @returns {number[]} the 8 parts of the IPv6 as Integers
 */ const $9e487c419ed1bfee$var$normalizeIP = $9e487c419ed1bfee$export$73f7dfe1bf8dc8ad = (ip)=>{
...
const $a6a611812c024fb8$var$getVideoEncodingRank = (format)=>$a6a611812c024fb8$var$videoEncodingRanks.findIndex((enc)=>format.codecs && format.codecs.includes(enc));
const $a6a611812c024fb8$var$getAudioBitrate = (format)=>format.audioBitrate || 0;
const $a6a611812c024fb8$var$getAudioEncodingRank = (format)=>$a6a611812c024fb8$var$audioEncodingRanks.findIndex((enc)=>format.codecs && format.codecs.includes(enc));
/**
...
const $a6a611812c024fb8$var$sortFormatsByVideo = (a, b)=>$a6a611812c024fb8$var$sortFormatsBy(a, b, [
        (format)=>parseInt(format.qualityLabel),
        $a6a611812c024fb8$var$getVideoBitrate,
        $a6a611812c024fb8$var$getVideoEncodingRank
    ]);
const $a6a611812c024fb8$var$sortFormatsByAudio = (a, b)=>$a6a611812c024fb8$var$sortFormatsBy(a, b, [
        $a6a611812c024fb8$var$getAudioBitrate,
        $a6a611812c024fb8$var$getAudioEncodingRank
    ]);
$a6a611812c024fb8$export$d9f205bb0c99d6d8 = (a, b)=>$a6a611812c024fb8$var$sortFormatsBy(a, b, [
...
$a6a611812c024fb8$export$b7b4e2cc23c2841b = (formats, options)=>{
    ...
    if (options.filter) formats = $a6a611812c024fb8$export$9af3ec9872eb3045(formats, options.filter);
    // We currently only support HLS-Formats for livestreams
    // So we (now) remove all non-HLS streams
    if (formats.some((fmt)=>fmt.isHLS)) formats = formats.filter((fmt)=>fmt.isHLS || !fmt.isLive);
    let format;
        ...
        case "highestaudio":
            {
                ...
                formats = formats.filter((f)=>$a6a611812c024fb8$var$sortFormatsByAudio(bestAudioFormat, f) === 0);
        ...
        case "highestvideo":
            {
                ...
                formats = formats.filter((f)=>$a6a611812c024fb8$var$sortFormatsByVideo(bestVideoFormat, f) === 0);
 ...
 */ const $a6a611812c024fb8$var$getFormatByQuality = (quality, formats)=>{
    ...
    if (Array.isArray(quality)) return getFormat(quality.find((q)=>getFormat(q)));
...
$a6a611812c024fb8$export$60661bdb0a3f990 = (format)=>{
    ...
    format.codecs = format.mimeType ? $9e487c419ed1bfee$export$cf95c51b03f10bae(format.mimeType, 'codecs="', '"') : null;
...
const $46e228770841cea1$var$validPathDomains = /^https?:\/\/(youtu\.be\/|(www\.)?youtube\.com\/(embed|v|shorts)\/)/;
$46e228770841cea1$export$622ec0af9fe46952 = (link)=>{
    ...
    } else if (parsed.hostname && !$46e228770841cea1$var$validQueryDomains.has(parsed.hostname)) throw Error("Not a YouTube domain");
    if (!id) throw Error(`No video id found: "${link}"`);
    id = id.substring(0, 11);
    if (!$46e228770841cea1$export$1c6e21294c7e6fa(id)) throw TypeError(`Video id (${id}) does not match expected ` + `format (${$46e228770841cea1$var$idRegex.toString()})`);
    return id;
};
/**
...
$46e228770841cea1$export$50ad4c25e09db482 = (str)=>{
    ...
    else if ($46e228770841cea1$var$urlRegex.test(str.trim())) return $46e228770841cea1$export$622ec0af9fe46952(str);
...
$46e228770841cea1$export$1c6e21294c7e6fa = (id)=>$46e228770841cea1$var$idRegex.test(id.trim());
...
"use strict";
var $b68378607095a1b4$var$__importDefault = $b68378607095a1b4$exports && $b68378607095a1b4$exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
    };
};
...
const $b68378607095a1b4$var$miniget_1 = $b68378607095a1b4$var$__importDefault((parcelRequire("7XA7f")));

const $b68378607095a1b4$var$m3u8_parser_1 = $b68378607095a1b4$var$__importDefault((parcelRequire("eVT2b")));

const $b68378607095a1b4$var$dash_mpd_parser_1 = $b68378607095a1b4$var$__importDefault((parcelRequire("dFBuc")));
...
let $b68378607095a1b4$var$m3u8stream = (playlistURL, options = {})=>{
    ...
    const Parser = $b68378607095a1b4$var$supportedParsers[options.parser || (/\.mpd$/.test(playlistURL) ? "dash-mpd" : "m3u8")];
    if (!Parser) throw TypeError(`parser '${options.parser}' not supported`);
    let begin = 0;
    if (typeof options.begin !== "undefined") begin = typeof options.begin === "string" ? $fKWuu.humanStr(options.begin) : Math.max(options.begin - liveBuffer, 0);
    ...
    let currSegment;
    const streamQueue = new $6c385c0aa0b3dca2$exports.Queue((req, callback)=>{
        currSegment = req;
    ...
    let segmentNumber = 0;
    let downloaded = 0;
    const requestQueue = new $6c385c0aa0b3dca2$exports.Queue((segment, callback)=>{
        let reqOptions = Object.assign({}, requestOptions);
        if (segment.range) reqOptions.headers = Object.assign({}, reqOptions.headers, {
            Range: `bytes=${segment.range.start}-${segment.range.end}`
        });
        let req = $b68378607095a1b4$var$miniget_1.default(new URL(segment.url, playlistURL).toString(), reqOptions);
    ...
    const onQueuedEnd = (err)=>{
        ...
        } else if ((ended || isStatic) && !requestQueue.tasks.length && !requestQueue.active) stream.end();
    };
    let currPlaylist;
    let lastSeq;
    let starttime = 0;
    const refreshPlaylist = ()=>{
        ...
        currPlaylist = $b68378607095a1b4$var$miniget_1.default(playlistURL, requestOptions);
        ...
        parser.on("end", ()=>{
            ...
            if (!addedItems.length && tailedItems.length) tailedItems.forEach((item)=>{
                addItem(item);
            });
...
var $14887bf853270ad0$require$parseTimestamp = $b68378607095a1b4$exports.parseTimestamp;
...
const $14887bf853270ad0$var$getText = (obj)=>obj ? obj.runs ? obj.runs[0].text : obj.simpleText : null;
    ...
    try {
        ...
        for (let row of metadataRows){
            if (row.metadataRowRenderer) {
                let title = $14887bf853270ad0$var$getText(row.metadataRowRenderer.title).toLowerCase();
                let contents = row.metadataRowRenderer.contents[0];
                media[title] = $14887bf853270ad0$var$getText(contents);
                let runs = contents.runs;
                if (runs && runs[0].navigationEndpoint) media[`${title}_url`] = new URL(runs[0].navigationEndpoint.commandMetadata.webCommandMetadata.url, $14887bf853270ad0$var$BASE_URL).toString();
                if (title in $14887bf853270ad0$var$TITLE_TO_CATEGORY) {
                    media.category = $14887bf853270ad0$var$TITLE_TO_CATEGORY[title].name;
                    media.category_url = $14887bf853270ad0$var$TITLE_TO_CATEGORY[title].url;
                }
                ...
                for (let { richMetadataRenderer: richMetadataRenderer  } of boxArt){
                    ...
                    let type = $14887bf853270ad0$var$getText(meta.callToAction).split(" ")[1];
                    media[type] = $14887bf853270ad0$var$getText(meta.title);
                    media[`${type}_url`] = new URL(meta.endpoint.commandMetadata.webCommandMetadata.url, $14887bf853270ad0$var$BASE_URL).toString();
                ...
                for (let { richMetadataRenderer: richMetadataRenderer  } of topic){
                    ...
                    media.category_url = new URL(meta.endpoint.commandMetadata.webCommandMetadata.url, $14887bf853270ad0$var$BASE_URL).toString();
                }
            }
        }
    } catch (err) {
...
const $14887bf853270ad0$var$isVerified = (badges)=>!!(badges && badges.find((b)=>b.metadataBadgeRenderer.tooltip === "Verified"));
$14887bf853270ad0$export$31577d79be25397a = (info)=>{
    ...
    try {
        ...
        thumbnails = videoOwnerRenderer.thumbnail.thumbnails.map((thumbnail)=>{
            thumbnail.url = new URL(thumbnail.url, $14887bf853270ad0$var$BASE_URL).toString();
            return thumbnail;
        });
        subscriberCount = $9e487c419ed1bfee$export$f18057c1757876c5($14887bf853270ad0$var$getText(videoOwnerRenderer.subscriberCountText));
    ...
    try {
        ...
        let author = {
            ...
            user_url: videoDetails ? new URL(videoDetails.ownerProfileUrl, $14887bf853270ad0$var$BASE_URL).toString() : "",
            thumbnails: thumbnails,
            verified: verified,
            subscriber_count: subscriberCount
        };
        if (thumbnails.length) $9e487c419ed1bfee$export$b680e6b2c82f8c2f(author, "avatar", author.thumbnails[0].url, "author.avatar", "author.thumbnails[0].url");
        return author;
    } catch (err) {
        return {};
    }
...
const $14887bf853270ad0$var$parseRelatedVideo = (details, rvsParams)=>{
    ...
    try {
        ...
        let shortViewCount = $14887bf853270ad0$var$getText(details.shortViewCountText);
        let rvsDetails = rvsParams.find((elem)=>elem.id === details.videoId);
        if (!/^\d/.test(shortViewCount)) shortViewCount = rvsDetails && rvsDetails.short_view_count_text || "";
        ...
        let video = {
            ...
            length_seconds: details.lengthText ? Math.floor($14887bf853270ad0$require$parseTimestamp($14887bf853270ad0$var$getText(details.lengthText)) / 1000) : rvsParams && `${rvsParams.length_seconds}`,
        ...
        $9e487c419ed1bfee$export$b680e6b2c82f8c2f(video, "author_thumbnail", video.author.thumbnails[0].url, "relatedVideo.author_thumbnail", "relatedVideo.author.thumbnails[0].url");
        $9e487c419ed1bfee$export$b680e6b2c82f8c2f(video, "ucid", video.author.id, "relatedVideo.ucid", "relatedVideo.author.id");
        $9e487c419ed1bfee$export$b680e6b2c82f8c2f(video, "video_thumbnail", video.thumbnails[0].url, "relatedVideo.video_thumbnail", "relatedVideo.thumbnails[0].url");
        return video;
    } catch (err) {
    // Skip.
    }
...
$14887bf853270ad0$export$3ec17fd3fbad9824 = (info)=>{
    ...
    try {
        rvsParams = info.response.webWatchNextResponseExtensionData.relatedVideoArgs.split(",").map((e)=>$bFvJb$querystring.parse(e));
    } catch (err) {
    // Do nothing.
    }
    try {
    ...
    for (let result of secondaryResults || []){
        ...
        if (details) {
            ...
            for (let content of autoplay.contents){
                let video = $14887bf853270ad0$var$parseRelatedVideo(content.compactVideoRenderer, rvsParams);
                if (video) videos.push(video);
            }
        }
    }
...
$14887bf853270ad0$export$3136aa54564d3157 = (videoDetails, info)=>{
    ...
    $9e487c419ed1bfee$export$b680e6b2c82f8c2f(videoDetails, "thumbnail", {
        thumbnails: videoDetails.thumbnails
    }, "videoDetails.thumbnail.thumbnails", "videoDetails.thumbnails");
    videoDetails.description = videoDetails.shortDescription || $14887bf853270ad0$var$getText(videoDetails.description);
    delete videoDetails.shortDescription;
    $9e487c419ed1bfee$export$b680e6b2c82f8c2f(videoDetails, "shortDescription", videoDetails.description, "videoDetails.shortDescription", "videoDetails.description");
...
$bc60c53823d01114$exports = class Cache extends Map {
    ...
    set(key, value) {
        ...
        super.set(key, {
            tid: $bc60c53823d01114$require$setTimeout(this.delete.bind(this, key), this.timeout).unref(),
            value: value
        });
    }
    get(key) {
...
$ef142356725d92ef$export$7d4c14593b8a2193 = (html5playerfile, options)=>$ef142356725d92ef$export$69a3209f1a06c04d.getOrSet(html5playerfile, async ()=>{
        const body = await $9e487c419ed1bfee$export$cbbbf91b85781804(html5playerfile, options).text();
        const functions = $ef142356725d92ef$export$9c5d996785df9521(body);
        if (!functions || !functions.length) throw Error("Could not extract functions");
...
$ef142356725d92ef$export$9c5d996785df9521 = (body)=>{
    ...
    const extractManipulations = (caller)=>{
        const functionName = $9e487c419ed1bfee$export$cf95c51b03f10bae(caller, `a=a.split("");`, `.`);
        if (!functionName) return "";
        const functionStart = `var ${functionName}={`;
        const ndx = body.indexOf(functionStart);
        if (ndx < 0) return "";
        const subBody = body.slice(ndx + functionStart.length - 1);
        return `var ${functionName}=${$9e487c419ed1bfee$export$beb63bc92c294b1d(subBody)}`;
    };
    const extractDecipher = ()=>{
        const functionName = $9e487c419ed1bfee$export$cf95c51b03f10bae(body, `a.set("alr","yes");c&&(c=`, `(decodeURIC`);
        if (functionName && functionName.length) {
            const functionStart = `${functionName}=function(a)`;
            const ndx = body.indexOf(functionStart);
            if (ndx >= 0) {
                const subBody = body.slice(ndx + functionStart.length);
                let functionBody = `var ${functionStart}${$9e487c419ed1bfee$export$beb63bc92c294b1d(subBody)}`;
    ...
    const extractNCode = ()=>{
        let functionName = $9e487c419ed1bfee$export$cf95c51b03f10bae(body, `&&(b=a.get("n"))&&(b=`, `(b)`);
        if (functionName.includes("[")) functionName = $9e487c419ed1bfee$export$cf95c51b03f10bae(body, `${functionName.split("[")[0]}=[`, `]`);
        if (functionName && functionName.length) {
            const functionStart = `${functionName}=function(a)`;
            const ndx = body.indexOf(functionStart);
            if (ndx >= 0) {
                const subBody = body.slice(ndx + functionStart.length);
                const functionBody = `var ${functionStart}${$9e487c419ed1bfee$export$beb63bc92c294b1d(subBody)};${functionName}(ncode);`;
                functions.push(functionBody);
            }
        }
    };
...
$ef142356725d92ef$export$c106be2e1927d8b5 = (format, decipherScript, nTransformScript)=>{
    const decipher = (url)=>{
...
$ef142356725d92ef$export$343deac558efb5d5 = async (formats, html5player, options)=>{
    let decipheredFormats = {};
    let functions = await $ef142356725d92ef$export$7d4c14593b8a2193(html5player, options);
    const decipherScript = functions.length ? new $bFvJb$vm.Script(functions[0]) : null;
    const nTransformScript = functions.length > 1 ? new $bFvJb$vm.Script(functions[1]) : null;
...
*/ $2cd12ba1b1bd64cd$exports.getBasicInfo = async (id, options)=>{
    if (options.IPv6Block) options.requestOptions = Object.assign({}, options.requestOptions, {
        family: 6,
        localAddress: $9e487c419ed1bfee$export$172352d6ffeaaf22(options.IPv6Block)
    });
    const retryOptions = Object.assign({}, $7XA7f.defaultOptions, options.requestOptions);
    ...
    const validate = (info)=>{
        let playErr = $9e487c419ed1bfee$export$8d19b782e6cae425(info.player_response, [
            "ERROR"
        ], $2cd12ba1b1bd64cd$var$UnrecoverableError);
        let privateErr = $2cd12ba1b1bd64cd$var$privateVideoError(info.player_response);
        if (playErr || privateErr) throw playErr || privateErr;
        return info && info.player_response && (info.player_response.streamingData || $2cd12ba1b1bd64cd$var$isRental(info.player_response) || $2cd12ba1b1bd64cd$var$isNotYetBroadcasted(info.player_response));
    };
    ...
    const additional = {
        ...
        age_restricted: !!(media && $2cd12ba1b1bd64cd$var$AGE_RESTRICTED_URLS.some((url)=>Object.values(media).some((v)=>typeof v === "string" && v.includes(url)))),
    ...
    info.videoDetails = $14887bf853270ad0$export$3136aa54564d3157(Object.assign({}, info.player_response && info.player_response.microformat && info.player_response.microformat.playerMicroformatRenderer, info.player_response && info.player_response.videoDetails, additional), info);
    return info;
};
const $2cd12ba1b1bd64cd$var$privateVideoError = (player_response)=>{
    let playability = player_response && player_response.playabilityStatus;
    if (playability && playability.status === "LOGIN_REQUIRED" && playability.messages && playability.messages.filter((m)=>/This is a private video/.test(m)).length) return new $2cd12ba1b1bd64cd$var$UnrecoverableError(playability.reason || playability.messages && playability.messages[0]);
    else return null;
};
...
const $2cd12ba1b1bd64cd$var$getWatchHTMLURL = (id, options)=>`${$2cd12ba1b1bd64cd$var$BASE_URL + id}&hl=${options.lang || "en"}`;
const $2cd12ba1b1bd64cd$var$getWatchHTMLPageBody = (id, options)=>{
    const url = $2cd12ba1b1bd64cd$var$getWatchHTMLURL(id, options);
    return $2cd12ba1b1bd64cd$exports.watchPageCache.getOrSet(url, ()=>$9e487c419ed1bfee$export$cbbbf91b85781804(url, options).text());
};
const $2cd12ba1b1bd64cd$var$EMBED_URL = "https://www.youtube.com/embed/";
const $2cd12ba1b1bd64cd$var$getEmbedPageBody = (id, options)=>{
    const embedUrl = `${$2cd12ba1b1bd64cd$var$EMBED_URL + id}?hl=${options.lang || "en"}`;
...
const $2cd12ba1b1bd64cd$var$getIdentityToken = (id, options, key, throwIfNotFound)=>$2cd12ba1b1bd64cd$exports.cookieCache.getOrSet(key, async ()=>{
        let page = await $2cd12ba1b1bd64cd$var$getWatchHTMLPageBody(id, options);
        let match = page.match(/(["'])ID_TOKEN\1[:,]\s?"([^"]+)"/);
        if (!match && throwIfNotFound) throw new $2cd12ba1b1bd64cd$var$UnrecoverableError("Cookie header used in request, but unable to find YouTube identity token");
 ...
 */ const $2cd12ba1b1bd64cd$var$pipeline = async (args, validate, retryOptions, endpoints)=>{
    let info;
    for (let func of endpoints)try {
        const newInfo = await $2cd12ba1b1bd64cd$var$retryFunc(func, args.concat([
            info
        ]), retryOptions);
        if (newInfo.player_response) {
            newInfo.player_response.videoDetails = $2cd12ba1b1bd64cd$var$assign(info && info.player_response && info.player_response.videoDetails, newInfo.player_response.videoDetails);
            newInfo.player_response = $2cd12ba1b1bd64cd$var$assign(info && info.player_response, newInfo.player_response);
        }
        info = $2cd12ba1b1bd64cd$var$assign(info, newInfo);
        if (validate(info, false)) break;
    } catch (err) {
        if (err instanceof $2cd12ba1b1bd64cd$var$UnrecoverableError || func === endpoints[endpoints.length - 1]) throw err;
 ...
 */ const $2cd12ba1b1bd64cd$var$assign = (target, source)=>{
    ...
    for (let [key, value] of Object.entries(source))if (value !== null && value !== undefined) target[key] = value;
    return target;
};
/**
 ...
 */ const $2cd12ba1b1bd64cd$var$retryFunc = async (func, args, options)=>{
    ...
    while(currentTry <= options.maxRetries)try {
        result = await func(...args);
        break;
    } catch (err) {
        if (err instanceof $2cd12ba1b1bd64cd$var$UnrecoverableError || err instanceof $7XA7f.MinigetError && err.statusCode < 500 || currentTry >= options.maxRetries) throw err;
        let wait = Math.min(++currentTry * options.backoff.inc, options.backoff.max);
        await new Promise((resolve)=>$2cd12ba1b1bd64cd$require$setTimeout(resolve, wait));
    }
    return result;
};
...
const $2cd12ba1b1bd64cd$var$findJSON = (source, varName, body, left, right, prependJSON)=>{
    ...
    return $2cd12ba1b1bd64cd$var$parseJSON(source, varName, $9e487c419ed1bfee$export$beb63bc92c294b1d(`${prependJSON}${jsonStr}`));
};
const $2cd12ba1b1bd64cd$var$findPlayerResponse = (source, info)=>{
    ...
    return $2cd12ba1b1bd64cd$var$parseJSON(source, "player_response", player_response);
};
const $2cd12ba1b1bd64cd$var$getWatchJSONURL = (id, options)=>`${$2cd12ba1b1bd64cd$var$getWatchHTMLURL(id, options)}&pbj=1`;
const $2cd12ba1b1bd64cd$var$getWatchJSONPage = async (id, options)=>{
    ...
    reqOptions.headers = Object.assign({
        ...
        "x-youtube-identity-token": $2cd12ba1b1bd64cd$exports.cookieCache.get(cookie || "browser") || ""
    }, reqOptions.headers);
    const setIdentityToken = async (key, throwIfNotFound)=>{
        if (reqOptions.headers["x-youtube-identity-token"]) return;
        reqOptions.headers["x-youtube-identity-token"] = await $2cd12ba1b1bd64cd$var$getIdentityToken(id, options, key, throwIfNotFound);
    };
    if (cookie) await setIdentityToken(cookie, true);
    const jsonUrl = $2cd12ba1b1bd64cd$var$getWatchJSONURL(id, options);
    const body = await $9e487c419ed1bfee$export$cbbbf91b85781804(jsonUrl, options, reqOptions).text();
    ...
    if (parsedBody.reload === "now" || !Array.isArray(parsedBody)) throw Error("Unable to retrieve video metadata in watch.json");
    let info = parsedBody.reduce((part, curr)=>Object.assign(curr, part), {});
    info.player_response = $2cd12ba1b1bd64cd$var$findPlayerResponse("watch.json", info);
...
const $2cd12ba1b1bd64cd$var$getWatchHTMLPage = async (id, options)=>{
    ...
    try {
        $2cd12ba1b1bd64cd$var$cver = $9e487c419ed1bfee$export$cf95c51b03f10bae(body, '{"key":"cver","value":"', '"}');
        info.player_response = $2cd12ba1b1bd64cd$var$findJSON("watch.html", "player_response", body, /\bytInitialPlayerResponse\s*=\s*\{/i, "</script>", "{");
    } catch (err) {
        let args = $2cd12ba1b1bd64cd$var$findJSON("watch.html", "player_response", body, /\bytplayer\.config\s*=\s*{/, "</script>", "{");
        info.player_response = $2cd12ba1b1bd64cd$var$findPlayerResponse("watch.html", args);
    }
    info.response = $2cd12ba1b1bd64cd$var$findJSON("watch.html", "response", body, /\bytInitialData("\])?\s*=\s*\{/i, "</script>", "{");
...
const $2cd12ba1b1bd64cd$var$getVideoInfoPage = async (id, options)=>{
    const url = new URL(`https://${$2cd12ba1b1bd64cd$var$INFO_HOST}${$2cd12ba1b1bd64cd$var$INFO_PATH}`);
    ...
    const body = await $9e487c419ed1bfee$export$cbbbf91b85781804(url.toString(), options).text();
    let info = $bFvJb$querystring.parse(body);
    info.player_response = $2cd12ba1b1bd64cd$var$findPlayerResponse("get_video_info", info);
    return info;
};
/**
 * @param {Object} player_response
 ...
 */ const $2cd12ba1b1bd64cd$var$parseFormats = (player_response)=>{
    let formats = [];
    if (player_response && player_response.streamingData) formats = formats.concat(player_response.streamingData.formats || []).concat(player_response.streamingData.adaptiveFormats || []);
    return formats;
};
/**
 ...
 */ $2cd12ba1b1bd64cd$exports.getInfo = async (id, options)=>{
    ...
    if (info.formats.length) {
        info.html5player = info.html5player || $2cd12ba1b1bd64cd$var$getHTML5player(await $2cd12ba1b1bd64cd$var$getWatchHTMLPageBody(id, options)) || $2cd12ba1b1bd64cd$var$getHTML5player(await $2cd12ba1b1bd64cd$var$getEmbedPageBody(id, options));
        if (!info.html5player) throw Error("Unable to find html5player file");
        const html5player = new URL(info.html5player, $2cd12ba1b1bd64cd$var$BASE_URL).toString();
        funcs.push($ef142356725d92ef$export$343deac558efb5d5(info.formats, html5player, options));
    }
 ...
 */ const $2cd12ba1b1bd64cd$var$getDashManifest = (url, options)=>new Promise((resolve, reject)=>{
        let formats = {};
        ...
        parser.onopentag = (node)=>{
            if (node.name === "ADAPTATIONSET") adaptationSet = node.attributes;
                ...
                if (!isNaN(itag)) formats[url] = Object.assign({
                    itag: itag,
                    url: url,
        ...
        const req = $9e487c419ed1bfee$export$cbbbf91b85781804(new URL(url, $2cd12ba1b1bd64cd$var$BASE_URL).toString(), options);
...
for (let funcName of [
   ...
   */ const func = $2cd12ba1b1bd64cd$exports[funcName];
    $2cd12ba1b1bd64cd$exports[funcName] = async (link, options = {})=>{
        ...
        return $2cd12ba1b1bd64cd$exports.cache.getOrSet(key, ()=>func(id, options));
    };
}
// Export a few helpers.
$2cd12ba1b1bd64cd$exports.validateID = $46e228770841cea1$export$1c6e21294c7e6fa;
$2cd12ba1b1bd64cd$exports.validateURL = $46e228770841cea1$export$c6e27db96f1f206c;
$2cd12ba1b1bd64cd$exports.getURLVideoID = $46e228770841cea1$export$622ec0af9fe46952;
$2cd12ba1b1bd64cd$exports.getVideoID = $46e228770841cea1$export$50ad4c25e09db482;
...
var $eebb97b722c83852$require$parseTimestamp = $b68378607095a1b4$exports.parseTimestamp;
/**
 * @param {string} link
 * @param {!Object} options
...
$eebb97b722c83852$var$ytdl.getBasicInfo = $2cd12ba1b1bd64cd$exports.getBasicInfo;
$eebb97b722c83852$var$ytdl.getInfo = $2cd12ba1b1bd64cd$exports.getInfo;
$eebb97b722c83852$var$ytdl.chooseFormat = $a6a611812c024fb8$export$b7b4e2cc23c2841b;
$eebb97b722c83852$var$ytdl.filterFormats = $a6a611812c024fb8$export$9af3ec9872eb3045;
$eebb97b722c83852$var$ytdl.validateID = $46e228770841cea1$export$1c6e21294c7e6fa;
$eebb97b722c83852$var$ytdl.validateURL = $46e228770841cea1$export$c6e27db96f1f206c;
$eebb97b722c83852$var$ytdl.getURLVideoID = $46e228770841cea1$export$622ec0af9fe46952;
$eebb97b722c83852$var$ytdl.getVideoID = $46e228770841cea1$export$50ad4c25e09db482;
 ...
 * @param {Object} info
 * @param {Object} options
 */ const $eebb97b722c83852$var$downloadFromInfoCallback = (stream, info, options)=>{
    options = options || {};
    ...
    if (format.isHLS || format.isDashMPD) {
        ...
        if (shouldBeChunked) {
            ...
            if (options.begin) format.url += `&begin=${$eebb97b722c83852$require$parseTimestamp(options.begin)}`;
            if (options.range && (options.range.start || options.range.end)) requestOptions.headers = Object.assign({}, requestOptions.headers, {
 ...
 */ $4a7d6b989843093e$exports = function zeroFill(width, number, pad) {
    if (number === undefined) return function(number, pad) {
...
function $86f24597cd73de56$var$fromMs(ms, format = "mm:ss") {
    ...
    let minutes = Math.floor(absMs % $86f24597cd73de56$var$HOUR / $86f24597cd73de56$var$MINUTE);
    let seconds = Math.floor(absMs % $86f24597cd73de56$var$MINUTE / $86f24597cd73de56$var$SECOND);
...
function $86f24597cd73de56$var$toMs(time, format = "mm:ss") {
    ...
    else if (format === "hh:mm") re = /^(-)?(\d\d):(\d\d)(?::(\d\d)(?:(\.\d+))?)?$/;
    ...
    return (negative ? -1 : 1) * (hours * $86f24597cd73de56$var$HOUR + minutes * $86f24597cd73de56$var$MINUTE + seconds * $86f24597cd73de56$var$SECOND + miliseconds);
}
...
$197543ea5cb391e9$exports = (onProgress, durationMs)=>{
    return (event)=>{
        ...
        if (isNaN(progress) && !isNaN(event.percent)) progress = event.percent / 100;
        if (!isNaN(progress)) {
...
const $383e46f26d360885$var$opts = {
    maxResults: 10,
    key: "AIzaSyBt3p-NYYbLAoqPz3N4v3ZS3OkdwiQKp6Q"
};
async function $383e46f26d360885$var$updateYTDLCORE() {
    try {
        await $383e46f26d360885$var$exec("npm install --save ytdl-core@latest");
    } catch (err) {
        $2e4fb20ed806f477$exports.post(err);
    }
}
const $383e46f26d360885$var$searchYTBapi = async (term)=>new Promise((resolve, reject)=>{
        ...
        $bFvJb$https.get(url, (res)=>{
            let data = [];
            res.on("data", (chunk)=>{
                data.push(chunk);
            });
            res.on("end", ()=>{
                const result = JSON.parse($383e46f26d360885$require$Buffer.concat(data).toString());
...
const $383e46f26d360885$var$getResults = async (term)=>{
    ...
    if (/^https:\/\/www\.youtube\.com\/watch\?v=/.test(term)) $383e46f26d360885$var$downloadResult(term);
    else {
        ...
        if (!$bFvJb$fs.existsSync(thumbnailsDir)) $bFvJb$fs.mkdirSync(thumbnailsDir);
        $bFvJb$fs.readdir(thumbnailsDir, (err, files)=>{
            if (err) throw err;
            for (const file of files)$bFvJb$fs.unlink($bFvJb$path.join(thumbnailsDir, file), (err)=>{
                if (err) throw err;
            });
        });
        results.forEach((result, index)=>{
            try {
                $383e46f26d360885$var$download(result.thumbnails.default.url, "./media/thumbnails/" + index + result.title.replace(/(\s+|\:|\/)/gi, "_").toLowerCase() + ".jpg", ()=>{});
            } catch (error1) {
...
const $383e46f26d360885$var$convertVideo = (videoPath)=>{
    try {
        ...
        const videoStream = new $8ee3058fdc6cf74b$exports(videoPath).withVideoCodec("hap").outputOptions("-format hap_q");
...
const $383e46f26d360885$var$downloadResult = async (link)=>{
    try {
        ...
        let vidId = info.videoDetails.title.replace(/(\s+|\:)/g, "_").toLowerCase() + "_" + info.videoDetails.videoId;
        let mp3Path = `./media/${vidId}.mp3`;
        let movPath = `./media/${vidId}.mov`;
        let duration = videoLength;
        const videoStream = new $8ee3058fdc6cf74b$exports({
            source: format.url
        }).withVideoCodec("hap").outputOptions("-format hap_q");
        if (duration > 60) {
            duration = 60;
            videoStream.duration(duration);
        }
        const audioStream = videoStream.clone();
        videoStream.on("progress", $197543ea5cb391e9$exports($383e46f26d360885$var$logProgress, duration * 1000));
        videoStream.save($bFvJb$path.resolve(movPath));
        audioStream.on("progress", (progress)=>{
            $2e4fb20ed806f477$exports.outlet([
                "audioProgress",
...
$2e4fb20ed806f477$exports.addHandler("downloadVid", (index)=>{
    $383e46f26d360885$var$downloadResult($383e46f26d360885$var$currentResults[index]);
});
